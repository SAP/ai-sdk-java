...
import com.sap.ai.sdk.core.client.model.BckndInternalResourceGroupAnnotation;
import com.sap.ai.sdk.core.client.model.BckndInternalResourceGroupLabel;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public BckndInternalResourceGroup addLabelsItem( @Nonnull final BckndInternalResourceGroupLabel labelsItem) {
    if (this.labels == null) {
   ...
   * @return The same instance of type {@link BckndInternalResourceGroup}
   */
  @Nonnull public BckndInternalResourceGroup addAnnotationsItem( @Nonnull final BckndInternalResourceGroupAnnotation annotationsItem) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link BckndInternalResourceGroup} instance.
  ...
  /**
   * Set an unrecognizable property of this {@link BckndInternalResourceGroup} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    return Objects.equals(this.cloudSdkCustomFields, bckndInternalResourceGroup.cloudSdkCustomFields) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resourceGroupId, tenantId, zoneId, createdAt, labels, status, statusMessage, annotations, cloudSdkCustomFields);
  }
