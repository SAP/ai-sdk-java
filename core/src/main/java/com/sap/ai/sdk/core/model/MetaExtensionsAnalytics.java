...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for MetaExtensionsAnalytics. */
   ...
   */
  @Nonnull
  public MetaExtensionsAnalytics version(@Nonnull final String version) {
  ...
  /**
   * Set an unrecognizable property of this {@link MetaExtensionsAnalytics} instance. If the map
   ...
   * MetaExtensionsAnalytics} instance with all required arguments.
   */
