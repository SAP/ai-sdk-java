...
import com.sap.ai.sdk.core.client.model.TrckDetailsErrorResponse;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public TrckApiError addDetailsItem( @Nonnull final TrckDetailsErrorResponse detailsItem) {
  ...
  /**
   * Set an unrecognizable property of this {@link TrckApiError} instance. If the map previously contained a mapping
