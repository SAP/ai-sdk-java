...
// CHECKSTYLE:ON
{
  ...
  */
  @Nonnull public AiArtifact addlabelsItem( @Nonnull final AiLabel labelsItem) {
    if (this.labels == null) {
  ...
  */
  ...
  /**
   * Set an unrecognizable property of this {@link AiArtifact} instance. If the map previously contained a mapping
