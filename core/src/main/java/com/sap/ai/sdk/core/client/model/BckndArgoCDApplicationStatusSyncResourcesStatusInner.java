...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for BckndArgoCDApplicationStatusSyncResourcesStatusInner. */
  protected BckndArgoCDApplicationStatusSyncResourcesStatusInner() {}

  /**
   * Set the name of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner} instance and
   * return the same instance.
   *
   * @param name ArgoCD application object name
   * @return The same instance of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner}
   *     class
   */
  @Nonnull
  public BckndArgoCDApplicationStatusSyncResourcesStatusInner name(@Nullable final String name) {
    this.name = name;
    return this;
  }
   ...
   *
   * @return name The name of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner}
   *     instance.
   */
  @Nonnull
  ...
  /**
   * Set the kind of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner} instance and
   * return the same instance.
   *
   ...
   */
  @Nonnull
  public BckndArgoCDApplicationStatusSyncResourcesStatusInner kind(@Nullable final String kind) {
    this.kind = kind;
    return this;
  }
   ...
   *
   * @return kind The kind of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner}
   *     instance.
   */
  @Nonnull
   ...
   */
  @Nonnull
  public BckndArgoCDApplicationStatusSyncResourcesStatusInner status(
   ...
   *
   * @return status The status of this {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner}
   *     instance.
   */
  @Nonnull
   ...
   */
  @Nonnull
  public BckndArgoCDApplicationStatusSyncResourcesStatusInner message(
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if (!cloudSdkCustomFields.containsKey(name)) {
      throw new NoSuchElementException(
          "BckndArgoCDApplicationStatusSyncResourcesStatusInner has no field with name '"
              + name
              + "'.");
    }
   ...
   * BckndArgoCDApplicationStatusSyncResourcesStatusInner} instance. If the map previously contained
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndArgoCDApplicationStatusSyncResourcesStatusInner
        bckndArgoCDApplicationStatusSyncResourcesStatusInner =
            (BckndArgoCDApplicationStatusSyncResourcesStatusInner) o;
    return Objects.equals(
            this.cloudSdkCustomFields,
            bckndArgoCDApplicationStatusSyncResourcesStatusInner.cloudSdkCustomFields)
        ...
        && Objects.equals(
            this.message, bckndArgoCDApplicationStatusSyncResourcesStatusInner.message);
  }
  ...
  /**
   * Create a new {@link BckndArgoCDApplicationStatusSyncResourcesStatusInner} instance. No
