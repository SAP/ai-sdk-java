...
@Beta // CHECKSTYLE:OFF
public class AiConfigurationCreationResponse
// CHECKSTYLE:ON
{
  @JsonProperty("id")
  private String id;
  ...
  /** Default constructor for AiConfigurationCreationResponse. */
  protected AiConfigurationCreationResponse() {}

  /**
   * Set the id of this {@link AiConfigurationCreationResponse} instance and return the same
   * instance.
   *
   * @param id Generic ID
   ...
   */
  @Nonnull
  public AiConfigurationCreationResponse id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Set the message of this {@link AiConfigurationCreationResponse} instance and return the same
   * instance.
   *
   ...
   */
  @Nonnull
  public AiConfigurationCreationResponse message(@Nonnull final String message) {
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link AiConfigurationCreationResponse}.
   *
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final AiConfigurationCreationResponse aiConfigurationCreationResponse =
        (AiConfigurationCreationResponse) o;
    return Objects.equals(
            this.cloudSdkCustomFields, aiConfigurationCreationResponse.cloudSdkCustomFields)
        && Objects.equals(this.id, aiConfigurationCreationResponse.id)
        && Objects.equals(this.message, aiConfigurationCreationResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiConfigurationCreationResponse {\n");
   ...
   * AiConfigurationCreationResponse} instance with all required arguments.
   */
