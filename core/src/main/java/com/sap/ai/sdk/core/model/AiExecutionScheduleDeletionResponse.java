...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for AiExecutionScheduleDeletionResponse. */
  protected AiExecutionScheduleDeletionResponse() {}

  /**
   * Set the id of this {@link AiExecutionScheduleDeletionResponse} instance and return the same
   * instance.
   *
   * @param id Generic ID
   ...
   */
  @Nonnull
  public AiExecutionScheduleDeletionResponse id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Set the message of this {@link AiExecutionScheduleDeletionResponse} instance and return the
   * same instance.
   *
   ...
   */
  @Nonnull
  public AiExecutionScheduleDeletionResponse message(@Nonnull final String message) {
  ...
  /**
   * Set an unrecognizable property of this {@link AiExecutionScheduleDeletionResponse} instance. If
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final AiExecutionScheduleDeletionResponse aiExecutionScheduleDeletionResponse =
        (AiExecutionScheduleDeletionResponse) o;
    return Objects.equals(
            this.cloudSdkCustomFields, aiExecutionScheduleDeletionResponse.cloudSdkCustomFields)
        && Objects.equals(this.id, aiExecutionScheduleDeletionResponse.id)
        && Objects.equals(this.message, aiExecutionScheduleDeletionResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiExecutionScheduleDeletionResponse {\n");
   ...
   * AiExecutionScheduleDeletionResponse} instance with all required arguments.
   */
