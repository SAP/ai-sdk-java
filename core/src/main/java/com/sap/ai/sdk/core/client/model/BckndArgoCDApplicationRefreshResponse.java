...
// CHECKSTYLE:ON
{
  ...
  protected BckndArgoCDApplicationRefreshResponse() {  }
    ...
    */
   @Nonnull public BckndArgoCDApplicationRefreshResponse id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
  ...
  public void setId( @Nonnull final String id) {
   ...
   /**
    * Set the message of this {@link BckndArgoCDApplicationRefreshResponse} instance and return the same instance.
    *
    * @param message  Message
    * @return The same instance of this {@link BckndArgoCDApplicationRefreshResponse} class
    */
   @Nonnull public BckndArgoCDApplicationRefreshResponse message(@Nonnull final String message) {
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link BckndArgoCDApplicationRefreshResponse}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link BckndArgoCDApplicationRefreshResponse} instance.
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("BckndArgoCDApplicationRefreshResponse has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link BckndArgoCDApplicationRefreshResponse} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndArgoCDApplicationRefreshResponse bckndArgoCDApplicationRefreshResponse = (BckndArgoCDApplicationRefreshResponse) o;
    return Objects.equals(this.cloudSdkCustomFields, bckndArgoCDApplicationRefreshResponse.cloudSdkCustomFields) &&
