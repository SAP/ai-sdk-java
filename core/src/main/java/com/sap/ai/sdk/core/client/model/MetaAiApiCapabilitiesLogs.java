...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public MetaAiApiCapabilitiesLogs executions( @Nullable final Boolean executions) {
   ...
   * @return The same instance of this {@link MetaAiApiCapabilitiesLogs} class
   */
  @Nonnull public MetaAiApiCapabilitiesLogs deployments( @Nullable final Boolean deployments) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("MetaAiApiCapabilitiesLogs has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link MetaAiApiCapabilitiesLogs} instance. If the map previously contained a mapping
