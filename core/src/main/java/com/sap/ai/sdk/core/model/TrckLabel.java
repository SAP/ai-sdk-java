...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for TrckLabel. */
  protected TrckLabel() {}

  /**
   * Set the name of this {@link TrckLabel} instance and return the same instance.
   *
   * @param name Label name to label one or more metrics.
   *     \&quot;metrics.ai.sap.com/Artifact.name\&quot; is a reserved label to associate an artifact
   *     with the metrics
   * @return The same instance of this {@link TrckLabel} class
   */
  @Nonnull
  public TrckLabel name(@Nonnull final String name) {
    this.name = name;
    return this;
  }

  /**
   * Label name to label one or more metrics. \&quot;metrics.ai.sap.com/Artifact.name\&quot; is a
   * reserved label to associate an artifact with the metrics
   *
   ...
   */
  @Nonnull
  public TrckLabel value(@Nonnull final String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link TrckLabel} instance. If the map previously
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link TrckLabel} instance
  ...
  public interface Builder {
     ...
     *
     * @param name Label name to label one or more metrics.
     *     \&quot;metrics.ai.sap.com/Artifact.name\&quot; is a reserved label to associate an
     *     artifact with the metrics
