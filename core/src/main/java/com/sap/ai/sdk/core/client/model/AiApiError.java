...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public AiApiError requestId(@Nonnull final String requestId) {
   ...
   */
  @Nonnull
  public AiApiError target(@Nonnull final String target) {
    this.target = target;
    return this;
  }
   ...
   */
  @Nonnull
  public AiApiError details(@Nonnull final Object details) {
