...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for BckndError. */
   ...
   */
  @Nonnull
  public BckndError code(@Nonnull final String code) {
    this.code = code;
    return this;
  }
   ...
   */
  @Nonnull
  public BckndError message(@Nonnull final String message) {
  ...
  /**
   * Set an unrecognizable property of this {@link BckndError} instance. If the map previously
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link BckndError} instance
