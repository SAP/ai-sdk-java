...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public AiResourcesDetails backendDetails( @Nullable final Object backendDetails) {
  ...
  /**
   * Set an unrecognizable property of this {@link AiResourcesDetails} instance. If the map previously contained a mapping
