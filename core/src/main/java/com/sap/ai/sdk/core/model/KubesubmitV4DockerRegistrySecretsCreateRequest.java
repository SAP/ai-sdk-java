...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for KubesubmitV4DockerRegistrySecretsCreateRequest. */
  protected KubesubmitV4DockerRegistrySecretsCreateRequest() {}

  /**
   * Set the data of this {@link KubesubmitV4DockerRegistrySecretsCreateRequest} instance and return
   * the same instance.
   *
   ...
   */
  @Nonnull
  public KubesubmitV4DockerRegistrySecretsCreateRequest data(
      @Nonnull final BcknddockerRegistrySecretWithSensitiveDataRequestData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @Nonnull
  public BcknddockerRegistrySecretWithSensitiveDataRequestData getData() {
    return data;
  }
  ...
  /**
   * Set the name of this {@link KubesubmitV4DockerRegistrySecretsCreateRequest} instance and return
   * the same instance.
   *
   ...
   */
  @Nonnull
  public KubesubmitV4DockerRegistrySecretsCreateRequest name(@Nonnull final String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link KubesubmitV4DockerRegistrySecretsCreateRequest}
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final KubesubmitV4DockerRegistrySecretsCreateRequest
        kubesubmitV4DockerRegistrySecretsCreateRequest =
            (KubesubmitV4DockerRegistrySecretsCreateRequest) o;
    return Objects.equals(
            this.cloudSdkCustomFields,
            kubesubmitV4DockerRegistrySecretsCreateRequest.cloudSdkCustomFields)
   ...
   * KubesubmitV4DockerRegistrySecretsCreateRequest} instance with all required arguments.
   */
  public static Builder create() {
    return (data) ->
        (name) -> new KubesubmitV4DockerRegistrySecretsCreateRequest().data(data).name(name);
  }
