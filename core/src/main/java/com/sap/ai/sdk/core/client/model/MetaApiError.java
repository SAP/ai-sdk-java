...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link MetaApiError} class
   */
  @Nonnull public MetaApiError requestId( @Nullable final String requestId) {
   ...
   * @return The same instance of this {@link MetaApiError} class
   */
  @Nonnull public MetaApiError target( @Nullable final String target) {
    this.target = target;
    return this;
  }
   ...
   * @return The same instance of this {@link MetaApiError} class
   */
  @Nonnull public MetaApiError details( @Nullable final Object details) {
