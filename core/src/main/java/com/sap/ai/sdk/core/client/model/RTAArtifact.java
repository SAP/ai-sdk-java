...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link RTAArtifact} class
   */
  @Nonnull public RTAArtifact signature( @Nullable final String signature) {
   ...
   * @return The same instance of this {@link RTAArtifact} class
   */
  @Nonnull public RTAArtifact labels( @Nullable final List<RTALabel> labels) {
    this.labels = labels;
    return this;
  }
  /**
  ...
  /**
   * Set an unrecognizable property of this {@link RTAArtifact} instance. If the map previously contained a mapping
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, executionId, url, signature, kind, labels, createdAt, cloudSdkCustomFields);
  }
