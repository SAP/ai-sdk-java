...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for AiApiErrorWithId. */
   ...
   */
  @Nonnull
  public AiApiErrorWithId id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Nonnull
  public AiApiErrorWithId error(@Nonnull final AiApiError error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link AiApiErrorWithId}.
   *
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final AiApiErrorWithId aiApiErrorWithId = (AiApiErrorWithId) o;
    return Objects.equals(this.cloudSdkCustomFields, aiApiErrorWithId.cloudSdkCustomFields)
        && Objects.equals(this.id, aiApiErrorWithId.id)
        && Objects.equals(this.error, aiApiErrorWithId.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, error, cloudSdkCustomFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiApiErrorWithId {\n");
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link AiApiErrorWithId}
