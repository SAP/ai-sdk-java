...
import com.sap.ai.sdk.core.client.model.KpiApiError;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public KpiGet400Response error( @Nullable final KpiApiError error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link KpiGet400Response} instance. If the map previously contained a mapping
