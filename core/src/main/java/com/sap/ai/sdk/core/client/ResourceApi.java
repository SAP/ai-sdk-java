...
public class ResourceApi extends AbstractOpenApiService {
    ...
    */
     ...
     */
    @Nullable  public BckndResourceGetResponse get( @Nullable final String authorization) throws OpenApiRequestException {
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public BckndResourceGetResponse get() throws OpenApiRequestException {
        return get(null);
    }
     ...
     * @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable  public BckndResourcePatchResponse patch( @Nonnull final BckndResourcePatchBody bckndResourcePatchBody,  @Nullable final String authorization) throws OpenApiRequestException {
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public BckndResourcePatchResponse patch( @Nonnull final BckndResourcePatchBody bckndResourcePatchBody) throws OpenApiRequestException {
