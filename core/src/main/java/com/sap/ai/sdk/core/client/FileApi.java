...
public class FileApi extends BaseApi {
  ...
  private FileApi(@Nonnull final ApiClient apiClient) {
    super(apiClient);
  }
   ...
   */
  public FileApi withDefaultHeaders(@Nonnull final Map<String, String> defaultHeaders) {
    final var api = new FileApi(apiClient);
