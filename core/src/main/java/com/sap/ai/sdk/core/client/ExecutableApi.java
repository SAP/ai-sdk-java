...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public AiExecutable get( @Nonnull final String scenarioId,  @Nonnull final String executableId,  @Nonnull final String aiResourceGroup) throws OpenApiRequestException {
        ...
        final ParameterizedTypeReference<AiExecutable> localVarReturnType = new ParameterizedTypeReference<AiExecutable>() {};
     ...
     * @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable  public AiExecutableList query( @Nonnull final String scenarioId,  @Nonnull final String aiResourceGroup,  @Nullable final String versionId) throws OpenApiRequestException {
        final Object localVarPostBody = null;
        ...
        final ParameterizedTypeReference<AiExecutableList> localVarReturnType = new ParameterizedTypeReference<AiExecutableList>() {};
        return apiClient.invokeAPI(localVarPath, HttpMethod.GET, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public AiExecutableList query( @Nonnull final String scenarioId,  @Nonnull final String aiResourceGroup) throws OpenApiRequestException {
