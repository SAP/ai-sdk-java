...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public TrckDeleteMetricsResponse delete( @Nonnull final String aiResourceGroup,  @Nonnull final TrckExecutionId executionId) throws OpenApiRequestException {
        ...
        final ParameterizedTypeReference<TrckDeleteMetricsResponse> localVarReturnType = new ParameterizedTypeReference<TrckDeleteMetricsResponse>() {};
     ...
     * @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable  public TrckGetMetricResourceList find( @Nonnull final String aiResourceGroup,  @Nullable final String $filter,  @Nullable final List<String> executionIds,  @Nullable final List<String> $select) throws OpenApiRequestException {
        final Object localVarPostBody = null;
        ...
        final ParameterizedTypeReference<TrckGetMetricResourceList> localVarReturnType = new ParameterizedTypeReference<TrckGetMetricResourceList>() {};
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public TrckGetMetricResourceList find( @Nonnull final String aiResourceGroup) throws OpenApiRequestException {
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
     @Nonnull  public OpenApiResponse patch( @Nonnull final String aiResourceGroup,  @Nonnull final TrckMetricResource trckMetricResource) throws OpenApiRequestException {
