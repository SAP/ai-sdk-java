...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for AiScalingDetails. */
   ...
   */
  @Nonnull
  public AiScalingDetails backendDetails(@Nullable final Object backendDetails) {
  ...
  /**
   * Set an unrecognizable property of this {@link AiScalingDetails} instance. If the map previously
