...
public class KpiApi extends BaseApi {
  ...
  private KpiApi(@Nonnull final ApiClient apiClient) {
    super(apiClient);
  }
   ...
   */
  public KpiApi withDefaultHeaders(@Nonnull final Map<String, String> defaultHeaders) {
    final var api = new KpiApi(apiClient);
