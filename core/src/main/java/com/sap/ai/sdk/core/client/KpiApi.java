...
public class KpiApi extends AbstractOpenApiService {
    ...
    */
     ...
     */
    @Nullable  public KpiResultSet get( @Nullable final Set<KpiColumnName> $select) throws OpenApiRequestException {
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public KpiResultSet get() throws OpenApiRequestException {
        return get(null);
    }
}
