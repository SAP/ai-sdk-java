...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public MetaCapabilities get() throws OpenApiRequestException {
        ...
        final ParameterizedTypeReference<MetaCapabilities> localVarReturnType = new ParameterizedTypeReference<MetaCapabilities>() {};
