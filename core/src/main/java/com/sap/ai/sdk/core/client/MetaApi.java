...
public class MetaApi extends BaseApi {
  ...
  private MetaApi(@Nonnull final ApiClient apiClient) {
    super(apiClient);
  }
   ...
   */
  public MetaApi withDefaultHeaders(@Nonnull final Map<String, String> defaultHeaders) {
    final var api = new MetaApi(apiClient);
