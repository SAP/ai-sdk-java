...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public AiExecutionSchedule start(@Nonnull final OffsetDateTime start) {
    this.start = start;
    return this;
  }
   ...
   */
  @Nonnull
  public AiExecutionSchedule end(@Nonnull final OffsetDateTime end) {
    this.end = end;
    return this;
  }
   ...
   */
  @Nonnull
  public AiExecutionSchedule id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Nonnull
  public AiExecutionSchedule status(@Nonnull final AiExecutionScheduleStatus status) {
    this.status = status;
    return this;
  }
