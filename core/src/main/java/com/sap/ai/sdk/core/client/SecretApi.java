...
public class SecretApi extends BaseApi {
  ...
  private SecretApi(@Nonnull final ApiClient apiClient) {
    super(apiClient);
  }
   ...
   */
  public SecretApi withDefaultHeaders(@Nonnull final Map<String, String> defaultHeaders) {
    final var api = new SecretApi(apiClient);
