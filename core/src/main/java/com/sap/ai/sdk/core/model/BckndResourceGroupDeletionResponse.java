...
// CHECKSTYLE:ON
{
  ...
  /** Default constructor for BckndResourceGroupDeletionResponse. */
  protected BckndResourceGroupDeletionResponse() {}

  /**
   * Set the id of this {@link BckndResourceGroupDeletionResponse} instance and return the same
   * instance.
   *
   * @param id Generic ID
   ...
   */
  @Nonnull
  public BckndResourceGroupDeletionResponse id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Set the message of this {@link BckndResourceGroupDeletionResponse} instance and return the same
   * instance.
   *
   ...
   */
  @Nonnull
  public BckndResourceGroupDeletionResponse message(@Nonnull final String message) {
  ...
  /**
   * Set an unrecognizable property of this {@link BckndResourceGroupDeletionResponse} instance. If
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndResourceGroupDeletionResponse bckndResourceGroupDeletionResponse =
        (BckndResourceGroupDeletionResponse) o;
    return Objects.equals(
            this.cloudSdkCustomFields, bckndResourceGroupDeletionResponse.cloudSdkCustomFields)
        && Objects.equals(this.id, bckndResourceGroupDeletionResponse.id)
        && Objects.equals(this.message, bckndResourceGroupDeletionResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class BckndResourceGroupDeletionResponse {\n");
   ...
   * BckndResourceGroupDeletionResponse} instance with all required arguments.
   */
