...
// CHECKSTYLE:ON
{
  ...
  */
  ...
  /**
   * Get the value of an unrecognizable property of this {@link BckndAllArgoCDApplicationData} instance.
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("BckndAllArgoCDApplicationData has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link BckndAllArgoCDApplicationData} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndAllArgoCDApplicationData bckndAllArgoCDApplicationData = (BckndAllArgoCDApplicationData) o;
    return Objects.equals(this.cloudSdkCustomFields, bckndAllArgoCDApplicationData.cloudSdkCustomFields) &&
