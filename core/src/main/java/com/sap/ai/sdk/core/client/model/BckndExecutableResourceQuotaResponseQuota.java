...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public BckndExecutableResourceQuotaResponseQuota servingTemplateMaxCount( @Nullable final Integer servingTemplateMaxCount) {
   ...
   * @return The same instance of this {@link BckndExecutableResourceQuotaResponseQuota} class
   */
  @Nonnull public BckndExecutableResourceQuotaResponseQuota workflowTemplateMaxCount( @Nullable final Integer workflowTemplateMaxCount) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link BckndExecutableResourceQuotaResponseQuota} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("BckndExecutableResourceQuotaResponseQuota has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link BckndExecutableResourceQuotaResponseQuota} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndExecutableResourceQuotaResponseQuota bckndExecutableResourceQuotaResponseQuota = (BckndExecutableResourceQuotaResponseQuota) o;
    return Objects.equals(this.cloudSdkCustomFields, bckndExecutableResourceQuotaResponseQuota.cloudSdkCustomFields) &&
        Objects.equals(this.servingTemplateMaxCount, bckndExecutableResourceQuotaResponseQuota.servingTemplateMaxCount) &&
        Objects.equals(this.workflowTemplateMaxCount, bckndExecutableResourceQuotaResponseQuota.workflowTemplateMaxCount);
  }
