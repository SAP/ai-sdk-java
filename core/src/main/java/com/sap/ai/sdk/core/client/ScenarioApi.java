...
public class ScenarioApi extends BaseApi {
  ...
  private ScenarioApi(@Nonnull final ApiClient apiClient) {
    super(apiClient);
  }
   ...
   */
  public ScenarioApi withDefaultHeaders(@Nonnull final Map<String, String> defaultHeaders) {
    final var api = new ScenarioApi(apiClient);
