...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public MetaApiError code(@Nonnull final String code) {
    this.code = code;
    return this;
  }
   ...
   */
  @Nonnull
  public MetaApiError message(@Nonnull final String message) {
  ...
  /**
   * Set an unrecognizable property of this {@link MetaApiError} instance. If the map previously
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link MetaApiError} instance
