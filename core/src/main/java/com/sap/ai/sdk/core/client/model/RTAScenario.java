...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public RTAScenario addLabelsItem( @Nonnull final RTALabel labelsItem) {
    if (this.labels == null) {
  ...
  /**
   * Set an unrecognizable property of this {@link RTAScenario} instance. If the map previously contained a mapping
