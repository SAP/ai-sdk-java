...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public AiExecutionScheduleModificationRequest cron(@Nonnull final String cron) {
    this.cron = cron;
    return this;
  }
   ...
   */
  @Nonnull
  public AiExecutionScheduleModificationRequest start(@Nonnull final OffsetDateTime start) {
    this.start = start;
    return this;
  }
   ...
   */
  @Nonnull
  public AiExecutionScheduleModificationRequest end(@Nonnull final OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  public AiExecutionScheduleModificationRequest status(
      @Nonnull final AiExecutionScheduleStatus status) {
    this.status = status;
    return this;
  }
