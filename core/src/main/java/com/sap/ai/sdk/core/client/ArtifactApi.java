...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public AiArtifactCreationResponse create( @Nonnull final String aiResourceGroup,  @Nonnull final AiArtifactPostData aiArtifactPostData) throws OpenApiRequestException {
        ...
        final ParameterizedTypeReference<AiArtifactCreationResponse> localVarReturnType = new ParameterizedTypeReference<AiArtifactCreationResponse>() {};
     ...
     * @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable  public AiArtifact get( @Nonnull final String aiResourceGroup,  @Nonnull final String artifactId,  @Nullable final String $expand) throws OpenApiRequestException {
        final Object localVarPostBody = null;
        ...
        final ParameterizedTypeReference<AiArtifact> localVarReturnType = new ParameterizedTypeReference<AiArtifact>() {};
        return apiClient.invokeAPI(localVarPath, HttpMethod.GET, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public AiArtifact get( @Nonnull final String aiResourceGroup,  @Nonnull final String artifactId) throws OpenApiRequestException {
    ...
    @Nullable  public AiArtifactList query( @Nonnull final String aiResourceGroup,  @Nullable final String scenarioId,  @Nullable final String executionId,  @Nullable final String name,  @Nullable final String kind,  @Nullable final List<String> artifactLabelSelector,  @Nullable final Integer $top,  @Nullable final Integer $skip,  @Nullable final String $search,  @Nullable final Boolean searchCaseInsensitive,  @Nullable final String $expand) throws OpenApiRequestException {
        ...
        final ParameterizedTypeReference<AiArtifactList> localVarReturnType = new ParameterizedTypeReference<AiArtifactList>() {};
        return apiClient.invokeAPI(localVarPath, HttpMethod.GET, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
...
* @throws OpenApiRequestException if an error occurs while attempting to invoke the API
     */
    @Nullable   public AiArtifactList query( @Nonnull final String aiResourceGroup) throws OpenApiRequestException {
