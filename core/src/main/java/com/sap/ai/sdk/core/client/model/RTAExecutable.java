...
import com.sap.ai.sdk.core.client.model.RTAExecutableArtifact;
import com.sap.ai.sdk.core.client.model.RTAExecutableParameter;
import com.sap.ai.sdk.core.client.model.RTALabel;
...
// CHECKSTYLE:ON
{
  ...
  */
  @Nonnull public RTAExecutable addinputArtifactsItem( @Nonnull final RTAExecutableArtifact inputArtifactsItem) {
  ...
  * @return The same instance of type {@link RTAExecutable}
  */
  @Nonnull public RTAExecutable addparametersItem( @Nonnull final RTAExecutableParameter parametersItem) {
  ...
  * @return The same instance of type {@link RTAExecutable}
  */
  @Nonnull public RTAExecutable addlabelsItem( @Nonnull final RTALabel labelsItem) {
    if (this.labels == null) {
  ...
  */
  ...
  /**
   * Set an unrecognizable property of this {@link RTAExecutable} instance. If the map previously contained a mapping
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, scenarioId, inputArtifacts, outputArtifacts, parameters, deployable, labels, createdAt, modifiedAt, cloudSdkCustomFields);
  }
