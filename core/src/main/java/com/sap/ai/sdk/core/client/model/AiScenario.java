...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public AiScenario addLabelsItem( @Nonnull final AiScenarioLabel labelsItem) {
    if (this.labels == null) {
  ...
  /**
   * Set an unrecognizable property of this {@link AiScenario} instance. If the map previously contained a mapping
