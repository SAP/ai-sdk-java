...
import com.sap.ai.sdk.core.client.model.BckndServiceServicePlanItemMetadata;
...
// CHECKSTYLE:ON
{
  ...
  private BckndServiceServicePlanItemMetadata metadata;
   ...
   */
  @Nonnull public BckndServiceServicePlanItem description( @Nullable final String description) {
   ...
   * @return The same instance of this {@link BckndServiceServicePlanItem} class
   */
  @Nonnull public BckndServiceServicePlanItem free( @Nullable final Boolean free) {
    this.free = free;
    return this;
  }
   ...
   * @param free  if the service plan free
   */
  public void setFree( @Nullable final Boolean free) {
    this.free = free;
  }
   ...
   * @return The same instance of this {@link BckndServiceServicePlanItem} class
   */
  @Nonnull public BckndServiceServicePlanItem id( @Nullable final String id) {
    this.id = id;
    return this;
  }
   ...
   * @return The same instance of this {@link BckndServiceServicePlanItem} class
   */
  @Nonnull public BckndServiceServicePlanItem name( @Nullable final String name) {
    this.name = name;
    return this;
  }
   ...
   * @return The same instance of this {@link BckndServiceServicePlanItem} class
   */
  @Nonnull public BckndServiceServicePlanItem metadata( @Nullable final BckndServiceServicePlanItemMetadata metadata) {
   ...
   * @param metadata  The metadata of this {@link BckndServiceServicePlanItem}
   */
  public void setMetadata( @Nullable final BckndServiceServicePlanItemMetadata metadata) {
    this.metadata = metadata;
  }

  /**
   * Get the names of the unrecognizable properties of the {@link BckndServiceServicePlanItem}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link BckndServiceServicePlanItem} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("BckndServiceServicePlanItem has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link BckndServiceServicePlanItem} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final BckndServiceServicePlanItem bckndServiceServicePlanItem = (BckndServiceServicePlanItem) o;
    return Objects.equals(this.cloudSdkCustomFields, bckndServiceServicePlanItem.cloudSdkCustomFields) &&
        Objects.equals(this.description, bckndServiceServicePlanItem.description) &&
        Objects.equals(this.free, bckndServiceServicePlanItem.free) &&
        Objects.equals(this.id, bckndServiceServicePlanItem.id) &&
        Objects.equals(this.name, bckndServiceServicePlanItem.name) &&
        Objects.equals(this.metadata, bckndServiceServicePlanItem.metadata);
  }
  ...
  @Nonnull public String toString() {
    ...
    sb.append("class BckndServiceServicePlanItem {\n");
