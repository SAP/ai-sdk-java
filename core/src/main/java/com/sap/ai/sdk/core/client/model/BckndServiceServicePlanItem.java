...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public BckndServiceServicePlanItem description(@Nonnull final String description) {
   ...
   */
  @Nonnull
  public BckndServiceServicePlanItem free(@Nonnull final Boolean free) {
    this.free = free;
    return this;
  }
   ...
   */
  @Nonnull
  public BckndServiceServicePlanItem id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Nonnull
  public BckndServiceServicePlanItem name(@Nonnull final String name) {
    this.name = name;
    return this;
  }
  ...
  public BckndServiceServicePlanItem metadata(
      @Nonnull final BckndServiceServicePlanItemMetadata metadata) {
