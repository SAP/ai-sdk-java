...
import com.sap.ai.sdk.orchestration.client.model.GlobalStreamOptions;
...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link OrchestrationConfig} class
   */
  @Nonnull public OrchestrationConfig stream( @Nullable final Boolean stream) {
    this.stream = stream;
    return this;
  }
   ...
   */
  @Nonnull public Boolean isStream() {
    return stream;
  }
  ...
  /**
   * Set the streamOptions of this {@link OrchestrationConfig} instance and return the same instance.
   *
   * @param streamOptions  The streamOptions of this {@link OrchestrationConfig}
   * @return The same instance of this {@link OrchestrationConfig} class
   */
  @Nonnull public OrchestrationConfig streamOptions( @Nullable final GlobalStreamOptions streamOptions) {
   ...
   */
  @Nonnull public GlobalStreamOptions getStreamOptions() {
  ...
  /**
   * Set an unrecognizable property of this {@link OrchestrationConfig} instance. If the map previously contained a mapping
