...
public interface EmbeddingsInputText  {
     ...
     */
    record ListOfStrings(@com.fasterxml.jackson.annotation.JsonValue @Nonnull List<String> values) implements EmbeddingsInputText {}
     ...
     */
    record InnerString(@com.fasterxml.jackson.annotation.JsonValue @Nonnull String value) implements EmbeddingsInputText {}
