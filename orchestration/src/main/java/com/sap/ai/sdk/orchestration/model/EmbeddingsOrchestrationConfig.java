...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the modules of this {@link EmbeddingsOrchestrationConfig} instance and return the same instance.
   *
   ...
   */
  @Nonnull public EmbeddingsOrchestrationConfig modules( @Nonnull final EmbeddingsModuleConfigs modules) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link EmbeddingsOrchestrationConfig} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsOrchestrationConfig has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsOrchestrationConfig} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsOrchestrationConfig} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final EmbeddingsOrchestrationConfig embeddingsOrchestrationConfig = (EmbeddingsOrchestrationConfig) o;
    return Objects.equals(this.cloudSdkCustomFields, embeddingsOrchestrationConfig.cloudSdkCustomFields) &&
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsOrchestrationConfig} instance with all required arguments.
    */
