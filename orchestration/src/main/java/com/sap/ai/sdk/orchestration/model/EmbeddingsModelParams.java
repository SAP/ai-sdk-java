...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public EmbeddingsModelParams dimensions( @Nullable final Integer dimensions) {
  ...
  /**
   * Set the encodingFormat of this {@link EmbeddingsModelParams} instance and return the same instance.
   *
   * @param encodingFormat  The encodingFormat of this {@link EmbeddingsModelParams}
   * @return The same instance of this {@link EmbeddingsModelParams} class
   */
  @Nonnull public EmbeddingsModelParams encodingFormat( @Nullable final EmbeddingsModelParamsEncodingFormat encodingFormat) {
   ...
   * @param encodingFormat  The encodingFormat of this {@link EmbeddingsModelParams}
   */
  public void setEncodingFormat( @Nullable final EmbeddingsModelParamsEncodingFormat encodingFormat) {
    this.encodingFormat = encodingFormat;
  }
   ...
   * @return The same instance of this {@link EmbeddingsModelParams} class
   */
  @Nonnull public EmbeddingsModelParams normalize( @Nullable final Boolean normalize) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsModelParams has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsModelParams} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsModelParams} instance. If the map previously contained a mapping
