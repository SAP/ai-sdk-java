...
import com.sap.ai.sdk.orchestration.model.ChatCompletionTokenLogprob;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ChoiceLogprobs content( @Nullable final List<ChatCompletionTokenLogprob> content) {
   ...
   */
  @Nonnull public ChoiceLogprobs addContentItem( @Nonnull final ChatCompletionTokenLogprob contentItem) {
   ...
   * @return The same instance of this {@link ChoiceLogprobs} class
   */
  @Nonnull public ChoiceLogprobs refusal( @Nullable final List<ChatCompletionTokenLogprob> refusal) {
   ...
   * @return The same instance of type {@link ChoiceLogprobs}
   */
  @Nonnull public ChoiceLogprobs addRefusalItem( @Nonnull final ChatCompletionTokenLogprob refusalItem) {
  ...
  /**
   * Get the value of all properties of this {@link ChoiceLogprobs} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link ChoiceLogprobs} instance. If the map previously contained a mapping
