...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ModuleResultsStreaming grounding( @Nullable final GenericModuleResult grounding) {
  ...
  /**
   * Set the templating of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param templating  The templating of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming templating( @Nullable final List<ChatMessage> templating) {
   ...
   */
  @Nonnull public ModuleResultsStreaming addTemplatingItem( @Nonnull final ChatMessage templatingItem) {
  ...
  /**
   * Set the inputTranslation of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param inputTranslation  The inputTranslation of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming inputTranslation( @Nullable final InputTranslationModuleResult inputTranslation) {
  ...
  /**
   * Set the inputMasking of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param inputMasking  The inputMasking of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming inputMasking( @Nullable final GenericModuleResult inputMasking) {
  ...
  /**
   * Set the inputFiltering of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param inputFiltering  The inputFiltering of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming inputFiltering( @Nullable final GenericModuleResult inputFiltering) {
  ...
  /**
   * Set the outputFiltering of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param outputFiltering  The outputFiltering of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming outputFiltering( @Nullable final GenericModuleResult outputFiltering) {
  ...
  /**
   * Set the outputTranslation of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param outputTranslation  The outputTranslation of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming outputTranslation( @Nullable final GenericModuleResult outputTranslation) {
   ...
   * @return outputTranslation  The outputTranslation of this {@link ModuleResultsStreaming} instance.
   */
  @Nonnull
   ...
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming llm( @Nullable final LLMModuleResultStreaming llm) {
    this.llm = llm;
    return this;
  }
  ...
  /**
   * Set the outputUnmasking of this {@link ModuleResultsStreaming} instance and return the same instance.
   *
   * @param outputUnmasking  The outputUnmasking of this {@link ModuleResultsStreaming}
   * @return The same instance of this {@link ModuleResultsStreaming} class
   */
  @Nonnull public ModuleResultsStreaming outputUnmasking( @Nullable final List<LLMChoiceStreaming> outputUnmasking) {
   ...
   * @return The same instance of type {@link ModuleResultsStreaming}
   */
  @Nonnull public ModuleResultsStreaming addOutputUnmaskingItem( @Nonnull final LLMChoiceStreaming outputUnmaskingItem) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ModuleResultsStreaming has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link ModuleResultsStreaming} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link ModuleResultsStreaming} instance. If the map previously contained a mapping
  ...
  @Override
  public int hashCode() {
    return Objects.hash(grounding, templating, inputTranslation, inputMasking, inputFiltering, outputFiltering, outputTranslation, llm, outputUnmasking, cloudSdkCustomFields);
  }
