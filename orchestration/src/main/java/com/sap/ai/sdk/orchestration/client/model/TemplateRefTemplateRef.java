...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public TemplateRefTemplateRef id(@Nonnull final String id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Nonnull
  public TemplateRefTemplateRef scenario(@Nonnull final String scenario) {
   ...
   */
  @Nonnull
  public TemplateRefTemplateRef name(@Nonnull final String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @Nonnull
  public TemplateRefTemplateRef version(@Nonnull final String version) {
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if (!cloudSdkCustomFields.containsKey(name)) {
      throw new NoSuchElementException(
          "TemplateRefTemplateRef has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link TemplateRefTemplateRef} instance. If the map
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link TemplateRefTemplateRef}
