...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public GlobalStreamOptions enabled( @Nullable final Boolean enabled) {
   ...
   *
   * @param chunkSize  Minimum number of characters per chunk that post-LLM modules operate on.
   * Minimum: 1
   * Maximum: 10000
   * @return The same instance of this {@link GlobalStreamOptions} class
   */
  @Nonnull public GlobalStreamOptions chunkSize( @Nullable final Integer chunkSize) {
   ...
   *
   * @param delimiters  List of delimiters to split the input text into chunks.Please note, this is a required parameter when &#x60;input_translation_module_config&#x60; or &#x60;output_translation_module_config&#x60; are configured.
   * @return The same instance of this {@link GlobalStreamOptions} class
   */
  @Nonnull public GlobalStreamOptions delimiters( @Nullable final List<String> delimiters) {
   ...
   */
  @Nonnull public GlobalStreamOptions addDelimitersItem( @Nonnull final String delimitersItem) {
  ...
  /**
   * Set an unrecognizable property of this {@link GlobalStreamOptions} instance. If the map previously contained a mapping
