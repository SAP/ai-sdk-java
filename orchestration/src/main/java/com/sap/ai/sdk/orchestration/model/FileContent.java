...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public FileContent fileData( @Nonnull final String fileData) {
   ...
   * @return The same instance of this {@link FileContent} class
   */
  @Nonnull public FileContent filename( @Nullable final String filename) {
  ...
  /**
   * Get the value of all properties of this {@link FileContent} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link FileContent} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link FileContent} instance with all required arguments.
    */
