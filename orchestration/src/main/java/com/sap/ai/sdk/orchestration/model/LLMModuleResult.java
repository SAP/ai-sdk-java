...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link LLMModuleResult} class
   */
  @Nonnull public LLMModuleResult citations( @Nullable final List<Citation> citations) {
   ...
   * @return The same instance of type {@link LLMModuleResult}
   */
  @Nonnull public LLMModuleResult addCitationsItem( @Nonnull final Citation citationsItem) {
  ...
  /**
   * Get the value of all properties of this {@link LLMModuleResult} instance including unrecognized properties.
   *
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, created, model, systemFingerprint, choices, usage, citations, cloudSdkCustomFields);
  }
