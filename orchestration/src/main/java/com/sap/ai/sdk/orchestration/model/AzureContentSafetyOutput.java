...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public AzureContentSafetyOutput hate( @Nullable final AzureThreshold hate) {
    this.hate = hate;
    return this;
  }
   ...
   * @return The same instance of this {@link AzureContentSafetyOutput} class
   */
  @Nonnull public AzureContentSafetyOutput selfHarm( @Nullable final AzureThreshold selfHarm) {
   ...
   * @return The same instance of this {@link AzureContentSafetyOutput} class
   */
  @Nonnull public AzureContentSafetyOutput sexual( @Nullable final AzureThreshold sexual) {
    this.sexual = sexual;
    return this;
  }
   ...
   * @return The same instance of this {@link AzureContentSafetyOutput} class
   */
  @Nonnull public AzureContentSafetyOutput violence( @Nullable final AzureThreshold violence) {
   ...
   *
   * @param protectedMaterialCode  Detect protected code content from known GitHub repositories. The scan includes software libraries, source code, algorithms, and other proprietary programming content.
   * @return The same instance of this {@link AzureContentSafetyOutput} class
   */
  @Nonnull public AzureContentSafetyOutput protectedMaterialCode( @Nullable final Boolean protectedMaterialCode) {
  ...
  /**
   * Get the value of all properties of this {@link AzureContentSafetyOutput} instance including unrecognized properties.
   *
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( protectedMaterialCode != null ) declaredFields.put("protectedMaterialCode", protectedMaterialCode);
    return declaredFields;
  }

  /**
   * Set an unrecognizable property of this {@link AzureContentSafetyOutput} instance. If the map previously contained a mapping
