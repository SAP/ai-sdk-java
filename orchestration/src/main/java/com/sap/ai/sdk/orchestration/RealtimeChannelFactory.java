...
public class RealtimeChannelFactory {
     ...
     *
     * @param audioOutputConsumer - audio bytes consumer, where byte[] - chunks of raw PCM mono 24000 Hz output and
     *                            Boolean - marker if current audio reply has been finished (current response ended)
     * @return input channel, allowing for text input
     */
    public TextInputChannel textToSpeech(@Nonnull final BiConsumer<byte[], Boolean> audioOutputConsumer) {
