...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public LLMModelDetails name( @Nonnull final String name) {
    this.name = name;
    return this;
  }
   ...
   * @return The same instance of this {@link LLMModelDetails} class
   */
  @Nonnull public LLMModelDetails version( @Nullable final String version) {
   ...
   *
   * @param params  Additional parameters for the model. Default values are used for mandatory parameters.
   * @return The same instance of this {@link LLMModelDetails} class
   */
  @Nonnull public LLMModelDetails params( @Nullable final Map<String, Object> params) {
    this.params = params;
    return this;
  }
   ...
   */
  @Nonnull public LLMModelDetails putparamsItem( @Nonnull final String key, @Nullable final Object paramsItem) {
    if (this.params == null) {
   ...
   *
   * @param timeout  Timeout for the LLM request in seconds. This parameter is currently ignored for Vertex AI models.
   * Minimum: 1
   * Maximum: 600
   * @return The same instance of this {@link LLMModelDetails} class
   */
  @Nonnull public LLMModelDetails timeout( @Nullable final Integer timeout) {
   ...
   *
   * @param maxRetries  Maximum number of retries for the LLM request. This parameter is currently ignored for Vertex AI models.
   * Minimum: 0
   * Maximum: 5
   * @return The same instance of this {@link LLMModelDetails} class
   */
  @Nonnull public LLMModelDetails maxRetries( @Nullable final Integer maxRetries) {
  ...
  /**
   * Set an unrecognizable property of this {@link LLMModelDetails} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link LLMModelDetails} instance with all required arguments.
    */
