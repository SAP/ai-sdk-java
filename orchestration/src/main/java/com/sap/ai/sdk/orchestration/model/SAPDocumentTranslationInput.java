...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public SAPDocumentTranslationInput type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Set the translateMessagesHistory of this {@link SAPDocumentTranslationInput} instance and return the same instance.
   *
   * @param translateMessagesHistory  If true, the messages history will be translated as well.
   * @return The same instance of this {@link SAPDocumentTranslationInput} class
   */
  @Nonnull public SAPDocumentTranslationInput translateMessagesHistory( @Nullable final Boolean translateMessagesHistory) {
   ...
   * @return translateMessagesHistory  The translateMessagesHistory of this {@link SAPDocumentTranslationInput} instance.
   */
  @Nonnull
   ...
   * @return The same instance of this {@link SAPDocumentTranslationInput} class
   */
  @Nonnull public SAPDocumentTranslationInput config( @Nonnull final SAPDocumentTranslationInputConfig config) {
    this.config = config;
    return this;
  }
  ...
  /**
   * Get the value of all properties of this {@link SAPDocumentTranslationInput} instance including unrecognized properties.
   *
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( translateMessagesHistory != null ) declaredFields.put("translateMessagesHistory", translateMessagesHistory);
    if( config != null ) declaredFields.put("config", config);
    return declaredFields;
  }

  /**
   * Set an unrecognizable property of this {@link SAPDocumentTranslationInput} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link SAPDocumentTranslationInput} instance with all required arguments.
    */
