...
// CHECKSTYLE:ON
{
  ...
  public enum CategoryEnum {
    ...
    */
    @JsonCreator
    @Nonnull public static CategoryEnum fromValue(@Nonnull final String value) {
   ...
   */
  @Nonnull public SAPDocumentTranslationApplyToSelector category( @Nonnull final CategoryEnum category) {
   ...
   * @return The same instance of this {@link SAPDocumentTranslationApplyToSelector} class
   */
  @Nonnull public SAPDocumentTranslationApplyToSelector items( @Nonnull final List<String> items) {
    this.items = items;
    return this;
  }
  /**
   ...
   */
  @Nonnull public SAPDocumentTranslationApplyToSelector addItemsItem( @Nonnull final String itemsItem) {
    if (this.items == null) {
  ...
  /**
   * Set the sourceLanguage of this {@link SAPDocumentTranslationApplyToSelector} instance and return the same instance.
   *
   * @param sourceLanguage  Language of the text to be translated.
   * @return The same instance of this {@link SAPDocumentTranslationApplyToSelector} class
   */
  @Nonnull public SAPDocumentTranslationApplyToSelector sourceLanguage( @Nullable final String sourceLanguage) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("SAPDocumentTranslationApplyToSelector has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link SAPDocumentTranslationApplyToSelector} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link SAPDocumentTranslationApplyToSelector} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final SAPDocumentTranslationApplyToSelector saPDocumentTranslationApplyToSelector = (SAPDocumentTranslationApplyToSelector) o;
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link SAPDocumentTranslationApplyToSelector} instance with all required arguments.
    */
    public static Builder create() {
        return (category) -> (items) -> new SAPDocumentTranslationApplyToSelector().category(category).items(items);
    }
    /**
