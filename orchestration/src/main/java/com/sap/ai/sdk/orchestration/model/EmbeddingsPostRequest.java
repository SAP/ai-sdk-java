...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public EmbeddingsPostRequest config( @Nonnull final EmbeddingsOrchestrationConfig config) {
    this.config = config;
    return this;
  }
   ...
   * @return The same instance of this {@link EmbeddingsPostRequest} class
   */
  @Nonnull public EmbeddingsPostRequest input( @Nonnull final EmbeddingsInput input) {
    this.input = input;
    return this;
  }
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsPostRequest has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsPostRequest} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsPostRequest} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsPostRequest} instance with all required arguments.
    */
