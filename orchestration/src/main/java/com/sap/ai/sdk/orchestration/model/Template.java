...
// CHECKSTYLE:ON
{
   ...
   *
   * @param template  A chat message array to be formatted with values from placeholder_values. Both role and content can be templated. If messages_history is provided, the templated messages will be appended.
   * @return The same instance of this {@link Template} class
   */
  @Nonnull public Template template( @Nonnull final List<ChatMessage> template) {
   ...
   */
  @Nonnull public Template addTemplateItem( @Nonnull final ChatMessage templateItem) {
   ...
   * @return The same instance of this {@link Template} class
   */
  @Nonnull public Template defaults( @Nullable final Map<String, String> defaults) {
   ...
   * @return The same instance of type {@link Template}
   */
  @Nonnull public Template putdefaultsItem( @Nonnull final String key, @Nonnull final String defaultsItem) {
   ...
   * @return The same instance of this {@link Template} class
   */
  @Nonnull public Template responseFormat( @Nullable final TemplateResponseFormat responseFormat) {
   ...
   *
   * @param tools  A list of tools the model may call. Used to provide a list of functions the model may generate JSON inputs for. This is the same as the OpenAI definition. 
   * @return The same instance of this {@link Template} class
   */
  @Nonnull public Template tools( @Nullable final List<ChatCompletionTool> tools) {
    this.tools = tools;
    return this;
  }
  /**
   ...
   * @return The same instance of type {@link Template}
   */
  @Nonnull public Template addToolsItem( @Nonnull final ChatCompletionTool toolsItem) {
    if (this.tools == null) {
  ...
  /**
   * Set an unrecognizable property of this {@link Template} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link Template} instance with all required arguments.
    */
