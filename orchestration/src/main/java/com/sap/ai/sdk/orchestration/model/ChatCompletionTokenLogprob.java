...
import com.sap.ai.sdk.orchestration.model.ChatCompletionTokenLogprobTopLogprobsInner;
...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link ChatCompletionTokenLogprob} class
   */
  @Nonnull public ChatCompletionTokenLogprob logprob( @Nonnull final Float logprob) {
   ...
   *
   * @param topLogprobs  List of the most likely tokens and their log probability, at this token position. In rare cases, there may be fewer than the number of requested &#x60;top_logprobs&#x60;.
   * @return The same instance of this {@link ChatCompletionTokenLogprob} class
   */
  @Nonnull public ChatCompletionTokenLogprob topLogprobs( @Nullable final List<ChatCompletionTokenLogprobTopLogprobsInner> topLogprobs) {
   ...
   * @param topLogprobs  List of the most likely tokens and their log probability, at this token position. In rare cases, there may be fewer than the number of requested &#x60;top_logprobs&#x60;.
   */
  public void setTopLogprobs( @Nullable final List<ChatCompletionTokenLogprobTopLogprobsInner> topLogprobs) {
    this.topLogprobs = topLogprobs;
  }
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link ChatCompletionTokenLogprob} instance with all required arguments.
    */
