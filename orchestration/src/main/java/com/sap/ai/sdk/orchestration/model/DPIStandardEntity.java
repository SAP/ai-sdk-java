...
import com.sap.ai.sdk.orchestration.model.DPIStandardEntityReplacementStrategy;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public DPIStandardEntity type( @Nonnull final DPIEntities type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link DPIStandardEntity} class
   */
  @Nonnull public DPIStandardEntity replacementStrategy( @Nullable final DPIStandardEntityReplacementStrategy replacementStrategy) {
  ...
  /**
   * Set an unrecognizable property of this {@link DPIStandardEntity} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link DPIStandardEntity} instance with all required arguments.
    */
