...
// CHECKSTYLE:ON
{
  ...
  public enum MethodEnum {
    ...
    */
    @JsonCreator
    @Nonnull public static MethodEnum fromValue(@Nonnull final String value) {
   ...
   */
  @Nonnull public MaskingProviderConfig type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link MaskingProviderConfig} class
   */
  @Nonnull public MaskingProviderConfig method( @Nonnull final MethodEnum method) {
    this.method = method;
    return this;
  }
   ...
   */
  @Nonnull public MethodEnum getMethod() {
    return method;
  }
   ...
   * @return The same instance of this {@link MaskingProviderConfig} class
   */
  @Nonnull public MaskingProviderConfig entities( @Nonnull final List<DPIEntityConfig> entities) {
   ...
   */
  @Nonnull public MaskingProviderConfig addEntitiesItem( @Nonnull final DPIEntityConfig entitiesItem) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("MaskingProviderConfig has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link MaskingProviderConfig} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link MaskingProviderConfig} instance with all required arguments.
    */
    public static Builder create() {
        return (type) -> (method) -> (entities) -> new MaskingProviderConfig().type(type).method(method).entities(entities);
    }
    /**
