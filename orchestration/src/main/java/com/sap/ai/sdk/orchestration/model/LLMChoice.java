...
import com.sap.ai.sdk.orchestration.model.ChoiceLogprobs;
...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link LLMChoice} class
   */
  @Nonnull public LLMChoice message( @Nonnull final ResponseChatMessage message) {
   ...
   * @return The same instance of this {@link LLMChoice} class
   */
  @Nonnull public LLMChoice logprobs( @Nullable final ChoiceLogprobs logprobs) {
   ...
   *
   * @param finishReason  Reason the model stopped generating tokens. &#39;stop&#39; if the model hit a natural stop point or a provided stop sequence, &#39;length&#39; if the maximum token number was reached, &#39;content_filter&#39; if content was omitted due to a filter enforced by the LLM model provider or the content filtering module
   * @return The same instance of this {@link LLMChoice} class
   */
  ...
  /**
   * Get the value of all properties of this {@link LLMChoice} instance including unrecognized properties.
   *
