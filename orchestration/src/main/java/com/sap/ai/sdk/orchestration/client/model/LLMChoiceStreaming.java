...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public LLMChoiceStreaming index( @Nonnull final Integer index) {
    this.index = index;
    return this;
  }
   ...
   * @return The same instance of this {@link LLMChoiceStreaming} class
   */
  @Nonnull public LLMChoiceStreaming delta( @Nonnull final ChatDelta delta) {
    this.delta = delta;
    return this;
  }
   ...
   * @return The same instance of this {@link LLMChoiceStreaming} class
   */
  @Nonnull public LLMChoiceStreaming logprobs( @Nullable final Map<String, List<BigDecimal>> logprobs) {
   ...
   */
  @Nonnull public LLMChoiceStreaming putlogprobsItem( @Nonnull final String key, @Nonnull final List<BigDecimal> logprobsItem) {
   ...
   * @return The same instance of this {@link LLMChoiceStreaming} class
   */
  @Nonnull public LLMChoiceStreaming finishReason( @Nullable final String finishReason) {
  ...
  /**
   * Set an unrecognizable property of this {@link LLMChoiceStreaming} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link LLMChoiceStreaming} instance with all required arguments.
    */
