...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ImageContentUrl url( @Nonnull final String url) {
    this.url = url;
    return this;
  }
   ...
   * @return The same instance of this {@link ImageContentUrl} class
   */
  @Nonnull public ImageContentUrl detail( @Nullable final String detail) {
    this.detail = detail;
    return this;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link ImageContentUrl} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link ImageContentUrl} instance with all required arguments.
    */
