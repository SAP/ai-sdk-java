...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public FilteringModuleConfig input( @Nullable final InputFilteringConfig input) {
    this.input = input;
    return this;
  }
   ...
   */
  @Nonnull public InputFilteringConfig getInput() {
    return input;
  }
   ...
   * @return The same instance of this {@link FilteringModuleConfig} class
   */
  @Nonnull public FilteringModuleConfig output( @Nullable final OutputFilteringConfig output) {
    this.output = output;
    return this;
  }
   ...
   */
  @Nonnull public OutputFilteringConfig getOutput() {
    return output;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link FilteringModuleConfig} instance. If the map previously contained a mapping
