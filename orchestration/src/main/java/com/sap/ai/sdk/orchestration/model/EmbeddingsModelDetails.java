...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public EmbeddingsModelDetails name( @Nonnull final String name) {
    this.name = name;
    return this;
  }
   ...
   * @return The same instance of this {@link EmbeddingsModelDetails} class
   */
  @Nonnull public EmbeddingsModelDetails version( @Nullable final String version) {
   ...
   * @return The same instance of this {@link EmbeddingsModelDetails} class
   */
  @Nonnull public EmbeddingsModelDetails params( @Nullable final EmbeddingsModelParams params) {
    this.params = params;
    return this;
  }
   ...
   *
   * @param timeout  Timeout for the Embeddings request in seconds. This parameter is currently ignored for Vertex AI models.
   * Minimum: 1
   * Maximum: 600
   * @return The same instance of this {@link EmbeddingsModelDetails} class
   */
  @Nonnull public EmbeddingsModelDetails timeout( @Nullable final Integer timeout) {
  ...
  /**
   * Set the maxRetries of this {@link EmbeddingsModelDetails} instance and return the same instance.
   *
   * @param maxRetries  Maximum number of retries for the Embeddings request. This parameter is currently ignored for Vertex AI models.
   * Minimum: 0
   * Maximum: 5
   * @return The same instance of this {@link EmbeddingsModelDetails} class
   */
  @Nonnull public EmbeddingsModelDetails maxRetries( @Nullable final Integer maxRetries) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsModelDetails has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsModelDetails} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsModelDetails} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsModelDetails} instance with all required arguments.
    */
