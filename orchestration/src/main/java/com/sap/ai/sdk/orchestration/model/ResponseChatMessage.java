...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ResponseChatMessage role( @Nonnull final RoleEnum role) {
    this.role = role;
    return this;
  }
   ...
   * @return The same instance of this {@link ResponseChatMessage} class
   */
  @Nonnull public ResponseChatMessage content( @Nullable final String content) {
   ...
   * @return The same instance of this {@link ResponseChatMessage} class
   */
  @Nonnull public ResponseChatMessage refusal( @Nullable final String refusal) {
   ...
   * @return The same instance of this {@link ResponseChatMessage} class
   */
  @Nonnull public ResponseChatMessage toolCalls( @Nullable final List<MessageToolCall> toolCalls) {
   ...
   */
  @Nonnull public ResponseChatMessage addToolCallsItem( @Nonnull final MessageToolCall toolCallsItem) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ResponseChatMessage has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link ResponseChatMessage} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link ResponseChatMessage} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link ResponseChatMessage} instance with all required arguments.
    */
