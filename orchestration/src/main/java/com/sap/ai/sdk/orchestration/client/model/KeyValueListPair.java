...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public KeyValueListPair key( @Nonnull final String key) {
    this.key = key;
    return this;
  }
   ...
   * @return The same instance of this {@link KeyValueListPair} class
   */
  @Nonnull public KeyValueListPair value( @Nonnull final List<String> value) {
    this.value = value;
    return this;
  }
  /**
   ...
   */
  @Nonnull public KeyValueListPair addValueItem( @Nonnull final String valueItem) {
    if (this.value == null) {
  ...
  /**
   * Set an unrecognizable property of this {@link KeyValueListPair} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link KeyValueListPair} instance with all required arguments.
    */
