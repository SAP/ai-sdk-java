...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the embeddings of this {@link EmbeddingsModuleConfigs} instance and return the same instance.
   *
   ...
   */
  @Nonnull public EmbeddingsModuleConfigs embeddings( @Nonnull final EmbeddingsModelConfig embeddings) {
   ...
   * @return The same instance of this {@link EmbeddingsModuleConfigs} class
   */
  @Nonnull public EmbeddingsModuleConfigs masking( @Nullable final MaskingModuleConfig masking) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsModuleConfigs has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsModuleConfigs} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsModuleConfigs} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsModuleConfigs} instance with all required arguments.
    */
