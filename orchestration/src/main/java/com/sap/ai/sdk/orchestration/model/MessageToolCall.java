...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public MessageToolCall id( @Nonnull final String id) {
    this.id = id;
    return this;
  }
   ...
   * @return The same instance of this {@link MessageToolCall} class
   */
  @Nonnull public MessageToolCall type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link MessageToolCall} class
   */
  @Nonnull public MessageToolCall function( @Nonnull final MessageToolCallFunction function) {
  ...
  /**
   * Set an unrecognizable property of this {@link MessageToolCall} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link MessageToolCall} instance with all required arguments.
    */
    public static Builder create() {
        return (id) -> (type) -> (function) -> new MessageToolCall().id(id).type(type).function(function);
    }
    /**
