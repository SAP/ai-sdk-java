...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public LlamaGuard38bFilterConfig type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link LlamaGuard38bFilterConfig} class
   */
  @Nonnull public LlamaGuard38bFilterConfig config( @Nonnull final LlamaGuard38b config) {
    this.config = config;
    return this;
  }
  ...
  /**
   * Get the value of all properties of this {@link LlamaGuard38bFilterConfig} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link LlamaGuard38bFilterConfig} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link LlamaGuard38bFilterConfig} instance with all required arguments.
    */
