...
import com.sap.ai.sdk.orchestration.model.EmbeddingsUsage;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public EmbeddingsResponse _object( @Nonnull final ObjectEnum _object) {
   ...
   * @return The same instance of this {@link EmbeddingsResponse} class
   */
  @Nonnull public EmbeddingsResponse data( @Nonnull final List<EmbeddingResult> data) {
    this.data = data;
    return this;
  }
  /**
   ...
   * @return The same instance of this {@link EmbeddingsResponse} class
   */
  @Nonnull public EmbeddingsResponse model( @Nonnull final String model) {
    this.model = model;
    return this;
  }
   ...
   * @return The same instance of this {@link EmbeddingsResponse} class
   */
  @Nonnull public EmbeddingsResponse usage( @Nonnull final EmbeddingsUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  /**
   * Get the value of all properties of this {@link EmbeddingsResponse} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsResponse} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsResponse} instance with all required arguments.
    */
    public static Builder create() {
        return (_object) -> (data) -> (model) -> (usage) -> new EmbeddingsResponse()._object(_object).data(data).model(model).usage(usage);
    }
    /**
