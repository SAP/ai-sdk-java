...
// CHECKSTYLE:ON
{
  ...
  public enum ScopeEnum {
    ...
    */
    @JsonCreator
    @Nonnull public static ScopeEnum fromValue(@Nonnull final String value) {
   ...
   *
   * @param scope  Defines the scope that is searched for the referenced template.  &#39;tenant&#39; indicates the template is shared across all resource groups within the tenant,  while &#39;resource_group&#39; indicates the template is only accessible within the specific resource group. 
   * @return The same instance of this {@link TemplateRefByID} class
   */
  @Nonnull public TemplateRefByID scope( @Nullable final ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
