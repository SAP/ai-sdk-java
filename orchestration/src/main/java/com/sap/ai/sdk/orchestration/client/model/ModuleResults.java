...
@JsonPropertyOrder({
  ModuleResults.JSON_PROPERTY_GROUNDING,
...
public class ModuleResults {
  ...
  public ModuleResults grounding(GenericModuleResult grounding) {
  ...
  @JsonProperty(JSON_PROPERTY_GROUNDING)
  ...
  @JsonProperty(JSON_PROPERTY_GROUNDING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrounding(GenericModuleResult grounding) {
    this.grounding = grounding;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.grounding, moduleResults.grounding)
  ...
  public int hashCode() {
    return Objects.hash(
        grounding, templating, inputMasking, inputFiltering, llm, outputFiltering, outputUnmasking);
  }
  ...
  public static class Builder {
    ...
    public ModuleResults.Builder grounding(GenericModuleResult grounding) {
