...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link ModuleResults} class
   */
  @Nonnull public ModuleResults outputUnmasking( @Nullable final List<ModuleResultsOutputUnmaskingInner> outputUnmasking) {
   ...
   * @return The same instance of type {@link ModuleResults}
   */
  @Nonnull public ModuleResults addOutputUnmaskingItem( @Nonnull final ModuleResultsOutputUnmaskingInner outputUnmaskingItem) {
   ...
   */
  @Nonnull public List<ModuleResultsOutputUnmaskingInner> getOutputUnmasking() {
   ...
   * @param outputUnmasking  The outputUnmasking of this {@link ModuleResults}
   */
  public void setOutputUnmasking( @Nullable final List<ModuleResultsOutputUnmaskingInner> outputUnmasking) {
    this.outputUnmasking = outputUnmasking;
  }
