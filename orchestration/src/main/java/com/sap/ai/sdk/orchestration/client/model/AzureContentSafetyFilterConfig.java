...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the type of this {@link AzureContentSafetyFilterConfig} instance and return the same instance.
   *
   ...
   */
  @Nonnull public AzureContentSafetyFilterConfig type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Set the config of this {@link AzureContentSafetyFilterConfig} instance and return the same instance.
   *
   * @param config  The config of this {@link AzureContentSafetyFilterConfig}
   * @return The same instance of this {@link AzureContentSafetyFilterConfig} class
   */
  @Nonnull public AzureContentSafetyFilterConfig config( @Nullable final AzureContentSafety config) {
    this.config = config;
    return this;
  }
   ...
   */
  @Nonnull public AzureContentSafety getConfig() {
    return config;
  }
  ...
  /**
   * Get the value of an unrecognizable property of this {@link AzureContentSafetyFilterConfig} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("AzureContentSafetyFilterConfig has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link AzureContentSafetyFilterConfig} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final AzureContentSafetyFilterConfig azureContentSafetyFilterConfig = (AzureContentSafetyFilterConfig) o;
    return Objects.equals(this.cloudSdkCustomFields, azureContentSafetyFilterConfig.cloudSdkCustomFields) &&
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link AzureContentSafetyFilterConfig} instance with all required arguments.
    */
