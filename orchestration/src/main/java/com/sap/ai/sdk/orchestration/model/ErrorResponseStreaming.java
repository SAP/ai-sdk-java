...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ErrorResponseStreaming error( @Nonnull final ErrorResponseStreamingError error) {
    this.error = error;
    return this;
  }
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ErrorResponseStreaming has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link ErrorResponseStreaming} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link ErrorResponseStreaming} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link ErrorResponseStreaming} instance with all required arguments.
    */
