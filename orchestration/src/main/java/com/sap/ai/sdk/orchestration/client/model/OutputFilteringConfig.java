...
import com.sap.ai.sdk.orchestration.client.model.FilteringStreamOptions;
...
// CHECKSTYLE:ON
{
   ...
   *
   * @param filters  Configuration for content filtering services that should be used for the given filtering step (input filtering or output filtering).
   * @return The same instance of this {@link OutputFilteringConfig} class
   */
  @Nonnull public OutputFilteringConfig filters( @Nonnull final List<FilterConfig> filters) {
   ...
   */
  @Nonnull public OutputFilteringConfig addFiltersItem( @Nonnull final FilterConfig filtersItem) {
   ...
   */
  @Nonnull public List<FilterConfig> getFilters() {
    return filters;
  }
   ...
   * @return The same instance of this {@link OutputFilteringConfig} class
   */
  @Nonnull public OutputFilteringConfig streamOptions( @Nullable final FilteringStreamOptions streamOptions) {
   ...
   */
  @Nonnull public FilteringStreamOptions getStreamOptions() {
  ...
  /**
   * Set an unrecognizable property of this {@link OutputFilteringConfig} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link OutputFilteringConfig} instance with all required arguments.
    */
