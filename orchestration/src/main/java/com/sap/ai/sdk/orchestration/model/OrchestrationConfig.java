...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public OrchestrationConfig modules( @Nonnull final OrchestrationConfigModules modules) {
   ...
   * @return The same instance of this {@link OrchestrationConfig} class
   */
  @Nonnull public OrchestrationConfig stream( @Nullable final GlobalStreamOptions stream) {
    this.stream = stream;
    return this;
  }
