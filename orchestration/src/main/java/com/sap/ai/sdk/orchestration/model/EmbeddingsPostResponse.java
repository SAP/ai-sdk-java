...
import com.sap.ai.sdk.orchestration.model.ModuleResultsBase;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public EmbeddingsPostResponse requestId( @Nonnull final String requestId) {
  ...
  /**
   * Set the intermediateResults of this {@link EmbeddingsPostResponse} instance and return the same instance.
   *
   * @param intermediateResults  The intermediateResults of this {@link EmbeddingsPostResponse}
   * @return The same instance of this {@link EmbeddingsPostResponse} class
   */
  @Nonnull public EmbeddingsPostResponse intermediateResults( @Nullable final ModuleResultsBase intermediateResults) {
   ...
   * @return intermediateResults  The intermediateResults of this {@link EmbeddingsPostResponse} instance.
   */
  @Nonnull
  ...
  /**
   * Set the finalResult of this {@link EmbeddingsPostResponse} instance and return the same instance.
   *
   * @param finalResult  The finalResult of this {@link EmbeddingsPostResponse}
   * @return The same instance of this {@link EmbeddingsPostResponse} class
   */
  @Nonnull public EmbeddingsPostResponse finalResult( @Nonnull final EmbeddingsResponse finalResult) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("EmbeddingsPostResponse has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link EmbeddingsPostResponse} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link EmbeddingsPostResponse} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link EmbeddingsPostResponse} instance with all required arguments.
    */
    public static Builder create() {
        return (requestId) -> (finalResult) -> new EmbeddingsPostResponse().requestId(requestId).finalResult(finalResult);
    }
    /**
