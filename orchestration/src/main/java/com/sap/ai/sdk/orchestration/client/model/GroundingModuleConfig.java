...
import com.sap.ai.sdk.orchestration.client.model.GroundingModuleConfigConfig;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public GroundingModuleConfig type( @Nullable final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   */
  @Nullable public TypeEnum getType() {
    return type;
  }
   ...
   * @return The same instance of this {@link GroundingModuleConfig} class
   */
  @Nonnull public GroundingModuleConfig config( @Nonnull final GroundingModuleConfigConfig config) {
    this.config = config;
    return this;
  }
   ...
   */
  @Nonnull public GroundingModuleConfigConfig getConfig() {
    return config;
  }
