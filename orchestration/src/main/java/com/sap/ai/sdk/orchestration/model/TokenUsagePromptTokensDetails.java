...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the audioTokens of this {@link TokenUsagePromptTokensDetails} instance and return the same instance.
   *
   ...
   */
  @Nonnull public TokenUsagePromptTokensDetails audioTokens( @Nullable final Integer audioTokens) {
  ...
  /**
   * Set the cachedTokens of this {@link TokenUsagePromptTokensDetails} instance and return the same instance.
   *
   * @param cachedTokens  Cached tokens present in the prompt.
   * @return The same instance of this {@link TokenUsagePromptTokensDetails} class
   */
  @Nonnull public TokenUsagePromptTokensDetails cachedTokens( @Nullable final Integer cachedTokens) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link TokenUsagePromptTokensDetails} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("TokenUsagePromptTokensDetails has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link TokenUsagePromptTokensDetails} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link TokenUsagePromptTokensDetails} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final TokenUsagePromptTokensDetails tokenUsagePromptTokensDetails = (TokenUsagePromptTokensDetails) o;
    return Objects.equals(this.cloudSdkCustomFields, tokenUsagePromptTokensDetails.cloudSdkCustomFields) &&
