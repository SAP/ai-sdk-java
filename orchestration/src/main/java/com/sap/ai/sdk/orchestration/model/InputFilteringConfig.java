...
// CHECKSTYLE:ON
{
   ...
   *
   * @param filters  Configuration for content filtering services that should be used for the given filtering step (input filtering).
   * @return The same instance of this {@link InputFilteringConfig} class
   */
  @Nonnull public InputFilteringConfig filters( @Nonnull final List<InputFilterConfig> filters) {
   ...
   */
  @Nonnull public InputFilteringConfig addFiltersItem( @Nonnull final InputFilterConfig filtersItem) {
