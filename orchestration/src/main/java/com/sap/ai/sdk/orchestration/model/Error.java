...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public Error requestId(@Nonnull final String requestId) {
   ...
   */
  @Nonnull
  public Error code(@Nonnull final Integer code) {
    this.code = code;
    return this;
  }
   ...
   */
  @Nonnull
  public Error message(@Nonnull final String message) {
   ...
   */
  @Nonnull
  public Error location(@Nonnull final String location) {
   ...
   */
  @Nonnull
  public Error intermediateResults(@Nullable final ModuleResults intermediateResults) {
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link Error} instance with
  ...
  public static Builder create() {
    return (requestId) ->
        (code) ->
            (message) ->
                (location) ->
                    new Error().requestId(requestId).code(code).message(message).location(location);
  }
