...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the requestId of this {@link Error} instance and return the same instance.
   *
   * @param requestId  The requestId of this {@link Error}
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error requestId( @Nonnull final String requestId) {
  ...
  /**
   * Get requestId
   * @return requestId  The requestId of this {@link Error} instance.
   */
  @Nonnull
  ...
  /**
   * Set the requestId of this {@link Error} instance.
   *
   * @param requestId  The requestId of this {@link Error}
   */
   ...
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error code( @Nonnull final Integer code) {
    this.code = code;
    return this;
  }
   ...
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error message( @Nonnull final String message) {
  ...
  /**
   * Set the location of this {@link Error} instance and return the same instance.
   *
   * @param location  Where the error occurred
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error location( @Nonnull final String location) {
   ...
   * @return location  The location of this {@link Error} instance.
   */
  @Nonnull
  ...
  /**
   * Set the location of this {@link Error} instance.
   *
   * @param location  Where the error occurred
   */
  ...
  /**
   * Set the intermediateResults of this {@link Error} instance and return the same instance.
   *
   * @param intermediateResults  The intermediateResults of this {@link Error}
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error intermediateResults( @Nullable final ModuleResults intermediateResults) {
   ...
   * @return intermediateResults  The intermediateResults of this {@link Error} instance.
   */
  @Nonnull
  ...
  /**
   * Set the intermediateResults of this {@link Error} instance.
   *
   * @param intermediateResults  The intermediateResults of this {@link Error}
   */
  public void setIntermediateResults( @Nullable final ModuleResults intermediateResults) {
    this.intermediateResults = intermediateResults;
  }
   ...
   * @return The same instance of this {@link Error} class
   */
  @Nonnull public Error headers( @Nullable final Map<String, String> headers) {
   ...
   */
  @Nonnull public Error putheadersItem( @Nonnull final String key, @Nonnull final String headersItem) {
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link Error} instance with all required arguments.
    */
    public static Builder create() {
        return (requestId) -> (code) -> (message) -> (location) -> new Error().requestId(requestId).code(code).message(message).location(location);
    }
    /**
    ...
    */
    public interface Builder3 {
        ...
        */
        Error location( @Nonnull final String location);
    }
