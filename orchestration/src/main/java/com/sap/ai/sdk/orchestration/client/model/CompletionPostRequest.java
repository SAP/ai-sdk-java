...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link CompletionPostRequest} class
   */
  @Nonnull public CompletionPostRequest inputParams( @Nullable final Map<String, String> inputParams) {
  ...
  /**
   * Set an unrecognizable property of this {@link CompletionPostRequest} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    */
    public static Builder create() {
        return (orchestrationConfig) -> new CompletionPostRequest().orchestrationConfig(orchestrationConfig);
    }
    /**
    ...
    */
    public interface Builder {
        ...
        */
        CompletionPostRequest orchestrationConfig( @Nonnull final OrchestrationConfig orchestrationConfig);
    }
