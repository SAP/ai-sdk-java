...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public GroundingModuleConfigConfigPlaceholders input( @Nonnull final List<String> input) {
    this.input = input;
    return this;
  }
  /**
   ...
   */
  @Nonnull public GroundingModuleConfigConfigPlaceholders addInputItem( @Nonnull final String inputItem) {
    if (this.input == null) {
   ...
   * @return The same instance of this {@link GroundingModuleConfigConfigPlaceholders} class
   */
  @Nonnull public GroundingModuleConfigConfigPlaceholders output( @Nonnull final String output) {
    this.output = output;
    return this;
  }
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("GroundingModuleConfigConfigPlaceholders has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Get the value of all properties of this {@link GroundingModuleConfigConfigPlaceholders} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link GroundingModuleConfigConfigPlaceholders} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final GroundingModuleConfigConfigPlaceholders groundingModuleConfigConfigPlaceholders = (GroundingModuleConfigConfigPlaceholders) o;
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link GroundingModuleConfigConfigPlaceholders} instance with all required arguments.
    */
    public static Builder create() {
        return (input) -> (output) -> new GroundingModuleConfigConfigPlaceholders().input(input).output(output);
    }
    /**
