...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public AzureContentSafetyInput hate( @Nullable final AzureThreshold hate) {
    this.hate = hate;
    return this;
  }
   ...
   * @return The same instance of this {@link AzureContentSafetyInput} class
   */
  @Nonnull public AzureContentSafetyInput selfHarm( @Nullable final AzureThreshold selfHarm) {
   ...
   * @return The same instance of this {@link AzureContentSafetyInput} class
   */
  @Nonnull public AzureContentSafetyInput sexual( @Nullable final AzureThreshold sexual) {
    this.sexual = sexual;
    return this;
  }
   ...
   * @return The same instance of this {@link AzureContentSafetyInput} class
   */
  @Nonnull public AzureContentSafetyInput violence( @Nullable final AzureThreshold violence) {
   ...
   *
   * @param promptShield  Filter prompts for harmful content such as jailbreaks and prompt injections.
   * @return The same instance of this {@link AzureContentSafetyInput} class
   */
  @Nonnull public AzureContentSafetyInput promptShield( @Nullable final Boolean promptShield) {
  ...
  /**
   * Get the value of all properties of this {@link AzureContentSafetyInput} instance including unrecognized properties.
   *
  ...
  /**
   * Set an unrecognizable property of this {@link AzureContentSafetyInput} instance. If the map previously contained a mapping
