...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public GroundingModuleConfigConfig filters( @Nullable final List<GroundingModuleConfigConfigFiltersInner> filters) {
   ...
   */
  @Nonnull public GroundingModuleConfigConfig addFiltersItem( @Nonnull final GroundingModuleConfigConfigFiltersInner filtersItem) {
   ...
   */
  @Nonnull public List<GroundingModuleConfigConfigFiltersInner> getFilters() {
    return filters;
  }
  ...
  /**
   * Set the inputParams of this {@link GroundingModuleConfigConfig} instance and return the same instance.
   *
   * @param inputParams  Contains the input parameters used for grounding input questions
   * @return The same instance of this {@link GroundingModuleConfigConfig} class
   */
  @Nonnull public GroundingModuleConfigConfig inputParams( @Nonnull final List<String> inputParams) {
   ...
   * @return The same instance of type {@link GroundingModuleConfigConfig}
   */
  @Nonnull public GroundingModuleConfigConfig addInputParamsItem( @Nonnull final String inputParamsItem) {
   ...
   */
  @Nonnull public List<String> getInputParams() {
    return inputParams;
  }
  ...
  /**
   * Set the outputParam of this {@link GroundingModuleConfigConfig} instance and return the same instance.
   *
   * @param outputParam  Parameter name used for grounding output
   * @return The same instance of this {@link GroundingModuleConfigConfig} class
   */
  @Nonnull public GroundingModuleConfigConfig outputParam( @Nonnull final String outputParam) {
   ...
   */
  @Nonnull public String getOutputParam() {
    return outputParam;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link GroundingModuleConfigConfig} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link GroundingModuleConfigConfig} instance with all required arguments.
    */
    public static Builder create() {
        return (inputParams) -> (outputParam) -> new GroundingModuleConfigConfig().inputParams(inputParams).outputParam(outputParam);
    }
    /**
