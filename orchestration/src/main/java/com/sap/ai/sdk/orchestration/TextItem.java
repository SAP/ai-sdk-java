...
public final class TextItem implements ContentItem, CacheablePrompt {
    ...
    /**
     * Compatibility method to support conversion from record to class without breaking changes,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(text, textItem.text) && Objects.equals(cacheControl, textItem.cacheControl);
    }
