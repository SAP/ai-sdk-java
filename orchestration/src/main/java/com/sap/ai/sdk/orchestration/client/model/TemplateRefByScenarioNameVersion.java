...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public TemplateRefByScenarioNameVersion scenario( @Nonnull final String scenario) {
   ...
   * @return The same instance of this {@link TemplateRefByScenarioNameVersion} class
   */
  @Nonnull public TemplateRefByScenarioNameVersion name( @Nonnull final String name) {
    this.name = name;
    return this;
  }
   ...
   * @return The same instance of this {@link TemplateRefByScenarioNameVersion} class
   */
  @Nonnull public TemplateRefByScenarioNameVersion version( @Nonnull final String version) {
  ...
  /**
   * Set an unrecognizable property of this {@link TemplateRefByScenarioNameVersion} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link TemplateRefByScenarioNameVersion} instance with all required arguments.
    */
    public static Builder create() {
        return (scenario) -> (name) -> (version) -> new TemplateRefByScenarioNameVersion().scenario(scenario).name(name).version(version);
    }
    /**
