...
import com.sap.ai.sdk.orchestration.client.model.GroundingFilter;
...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link GroundingModuleConfigGroundingServiceConfiguration} class
   */
  @Nonnull public GroundingModuleConfigGroundingServiceConfiguration filters( @Nullable final List<GroundingFilter> filters) {
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link GroundingModuleConfigGroundingServiceConfiguration}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link GroundingModuleConfigGroundingServiceConfiguration} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("GroundingModuleConfigGroundingServiceConfiguration has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link GroundingModuleConfigGroundingServiceConfiguration} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final GroundingModuleConfigGroundingServiceConfiguration groundingModuleConfigGroundingServiceConfiguration = (GroundingModuleConfigGroundingServiceConfiguration) o;
    return Objects.equals(this.cloudSdkCustomFields, groundingModuleConfigGroundingServiceConfiguration.cloudSdkCustomFields) &&
        Objects.equals(this.secretName, groundingModuleConfigGroundingServiceConfiguration.secretName) &&
        Objects.equals(this.filters, groundingModuleConfigGroundingServiceConfiguration.filters) &&
        Objects.equals(this.groundingInputParameters, groundingModuleConfigGroundingServiceConfiguration.groundingInputParameters) &&
        Objects.equals(this.groundingOutputParameter, groundingModuleConfigGroundingServiceConfiguration.groundingOutputParameter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(secretName, filters, groundingInputParameters, groundingOutputParameter, cloudSdkCustomFields);
  }
