...
import com.sap.ai.sdk.orchestration.client.model.GroundingModuleConfig;
...
// CHECKSTYLE:ON
{
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(llmModuleConfig, templatingModuleConfig, filteringModuleConfig, maskingModuleConfig, groundingModuleConfig, cloudSdkCustomFields);
  }
