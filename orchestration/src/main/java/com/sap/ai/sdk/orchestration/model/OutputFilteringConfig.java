...
// CHECKSTYLE:ON
{
   ...
   *
   * @param filters  Configuration for content filtering services that should be used for the given filtering step (output filtering).
   * @return The same instance of this {@link OutputFilteringConfig} class
   */
  @Nonnull public OutputFilteringConfig filters( @Nonnull final List<OutputFilterConfig> filters) {
   ...
   */
  @Nonnull public OutputFilteringConfig addFiltersItem( @Nonnull final OutputFilterConfig filtersItem) {
