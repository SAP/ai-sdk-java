...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public FilterConfig type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link FilterConfig} class
   */
  @Nonnull public FilterConfig config( @Nullable final AzureContentSafety config) {
    this.config = config;
    return this;
  }
  ...
  /**
   * Set an unrecognizable property of this {@link FilterConfig} instance. If the map previously contained a mapping
  ...
  private String toIndentedString(final java.lang.Object o) {
    ...
    /**
    * Create a type-safe, fluent-api builder object to construct a new {@link FilterConfig} instance with all required arguments.
    */
