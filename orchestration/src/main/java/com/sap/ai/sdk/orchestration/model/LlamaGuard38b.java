...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public LlamaGuard38b violentCrimes( @Nullable final Boolean violentCrimes) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b nonViolentCrimes( @Nullable final Boolean nonViolentCrimes) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b sexCrimes( @Nullable final Boolean sexCrimes) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b childExploitation( @Nullable final Boolean childExploitation) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b defamation( @Nullable final Boolean defamation) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b specializedAdvice( @Nullable final Boolean specializedAdvice) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b privacy( @Nullable final Boolean privacy) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b intellectualProperty( @Nullable final Boolean intellectualProperty) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b indiscriminateWeapons( @Nullable final Boolean indiscriminateWeapons) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b hate( @Nullable final Boolean hate) {
    this.hate = hate;
    return this;
  }
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b selfHarm( @Nullable final Boolean selfHarm) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b sexualContent( @Nullable final Boolean sexualContent) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b elections( @Nullable final Boolean elections) {
   ...
   * @return The same instance of this {@link LlamaGuard38b} class
   */
  @Nonnull public LlamaGuard38b codeInterpreterAbuse( @Nullable final Boolean codeInterpreterAbuse) {
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( intellectualProperty != null ) declaredFields.put("intellectualProperty", intellectualProperty);
    if( indiscriminateWeapons != null ) declaredFields.put("indiscriminateWeapons", indiscriminateWeapons);
    ...
    if( codeInterpreterAbuse != null ) declaredFields.put("codeInterpreterAbuse", codeInterpreterAbuse);
  ...
  @Override
  public int hashCode() {
    return Objects.hash(violentCrimes, nonViolentCrimes, sexCrimes, childExploitation, defamation, specializedAdvice, privacy, intellectualProperty, indiscriminateWeapons, hate, selfHarm, sexualContent, elections, codeInterpreterAbuse, cloudSdkCustomFields);
  }
