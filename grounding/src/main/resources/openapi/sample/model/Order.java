...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set an unrecognizable property of this {@link Order} instance. If the map previously contained
  ...
  public int hashCode() {
    return Objects.hash(
        productId, quantity, totalPrice, typelessProperty, nullableProperty, cloudSdkCustomFields);
  }
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link Order} instance with
