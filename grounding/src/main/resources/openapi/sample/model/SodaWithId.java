...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set an unrecognizable property of this {@link SodaWithId} instance. If the map previously
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link SodaWithId} instance
  ...
  public static Builder create() {
    return (name) ->
        (brand) ->
            (quantity) ->
                (price) -> new SodaWithId().name(name).brand(brand).quantity(quantity).price(price);
  }
