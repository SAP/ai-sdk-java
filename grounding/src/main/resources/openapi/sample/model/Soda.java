...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set an unrecognizable property of this {@link Soda} instance. If the map previously contained a
  ...
  /**
   * Create a type-safe, fluent-api builder object to construct a new {@link Soda} instance with all
   * required arguments.
   */
  public static Builder create() {
    return (name) ->
        (brand) ->
            (quantity) ->
                (price) -> new Soda().name(name).brand(brand).quantity(quantity).price(price);
  }
