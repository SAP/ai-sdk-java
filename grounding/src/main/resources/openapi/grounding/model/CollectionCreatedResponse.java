...
// CHECKSTYLE:ON
{
  ...
  private CollectionCreatedResponse() {}
  ...
  public static Builder builder() {
    return (collectionURL) ->
        (status) ->
            () -> new CollectionCreatedResponse().collectionURL(collectionURL).status(status);
  }
  ...
  public interface Builder2 {
    /**
     * Finalize the builder for new {@link CollectionCreatedResponse} instance.
     *
     * @return The CollectionCreatedResponse instance.
     */
    CollectionCreatedResponse build();
  }
}
