...
// CHECKSTYLE:ON
{
  ...
  private CollectionDeletedResponse() {}
  ...
  public static Builder builder() {
    return (collectionURL) ->
        (status) ->
            () -> new CollectionDeletedResponse().collectionURL(collectionURL).status(status);
  }
  ...
  public interface Builder2 {
    /**
     * Finalize the builder for new {@link CollectionDeletedResponse} instance.
     *
     * @return The CollectionDeletedResponse instance.
     */
    CollectionDeletedResponse build();
  }
}
