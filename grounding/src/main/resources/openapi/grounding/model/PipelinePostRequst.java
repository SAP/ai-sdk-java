...
import com.sap.cloud.sdk.datamodel.openapi.grounding.model.PipelinePostRequstConfiguration;
...
// CHECKSTYLE:ON
{
  ...
  public static Builder builder() {
    return (type) ->
        (_configuration) ->
            () -> new PipelinePostRequst().type(type)._configuration(_configuration);
  }
  ...
  public interface Builder1 {
     ...
     */
    Builder2 _configuration(@Nonnull final PipelinePostRequstConfiguration _configuration);
  }

  /** Builder helper class. */
  public interface Builder2 {
    /**
     * Finalize the builder for new {@link PipelinePostRequst} instance.
     *
     * @return The PipelinePostRequst instance.
     */
    PipelinePostRequst build();
  }
}
