...
/** OpenAIItemResourceType */
public interface OpenAIItemResourceType {
  /** Helper class to create {@code String } that implements {@link OpenAIItemResourceType}. */
  record InnerString(@com.fasterxml.jackson.annotation.JsonValue @Nonnull String value)
      implements OpenAIItemResourceType {}
