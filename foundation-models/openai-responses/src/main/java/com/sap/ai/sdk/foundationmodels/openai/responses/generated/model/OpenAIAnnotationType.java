...
/** OpenAIAnnotationType */
public interface OpenAIAnnotationType {
  /** Helper class to create {@code String } that implements {@link OpenAIAnnotationType}. */
  record InnerString(@com.fasterxml.jackson.annotation.JsonValue @Nonnull String value)
      implements OpenAIAnnotationType {}
