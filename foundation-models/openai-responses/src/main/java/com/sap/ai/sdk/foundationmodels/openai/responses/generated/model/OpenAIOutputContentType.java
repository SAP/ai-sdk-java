...
/** OpenAIOutputContentType */
public interface OpenAIOutputContentType {
  /** Helper class to create {@code String } that implements {@link OpenAIOutputContentType}. */
  record InnerString(@com.fasterxml.jackson.annotation.JsonValue @Nonnull String value)
      implements OpenAIOutputContentType {}
