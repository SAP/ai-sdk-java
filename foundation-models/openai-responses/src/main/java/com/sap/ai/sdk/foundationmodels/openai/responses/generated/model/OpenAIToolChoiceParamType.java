...
public interface OpenAIToolChoiceParamType {
  /** Helper class to create {@code String } that implements {@link OpenAIToolChoiceParamType}. */
  record InnerString(@com.fasterxml.jackson.annotation.JsonValue @Nonnull String value)
      implements OpenAIToolChoiceParamType {}
