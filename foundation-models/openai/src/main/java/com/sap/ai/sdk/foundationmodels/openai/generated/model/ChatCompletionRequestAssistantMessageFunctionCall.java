...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link ChatCompletionRequestAssistantMessageFunctionCall}
   *     class
   */
  @Nonnull
  public ChatCompletionRequestAssistantMessageFunctionCall arguments(
   ...
   *
   * @return arguments The arguments of this {@link
   *     ChatCompletionRequestAssistantMessageFunctionCall} instance.
   */
  @Nonnull
  ...
  /**
   * Set the name of this {@link ChatCompletionRequestAssistantMessageFunctionCall} instance and
   ...
   */
  @Nonnull
  public ChatCompletionRequestAssistantMessageFunctionCall name(@Nonnull final String name) {
    this.name = name;
    return this;
  }
   ...
   *
   * @return name The name of this {@link ChatCompletionRequestAssistantMessageFunctionCall}
   *     instance.
   */
  @Nonnull
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if (!cloudSdkCustomFields.containsKey(name)) {
      throw new NoSuchElementException(
          "ChatCompletionRequestAssistantMessageFunctionCall has no field with name '"
              + name
              + "'.");
    }
   ...
   * ChatCompletionRequestAssistantMessageFunctionCall} instance including unrecognized properties.
   *
   ...
   * ChatCompletionRequestAssistantMessageFunctionCall} instance. If the map previously contained a
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final ChatCompletionRequestAssistantMessageFunctionCall
        chatCompletionRequestAssistantMessageFunctionCall =
            (ChatCompletionRequestAssistantMessageFunctionCall) o;
    return Objects.equals(
            this.cloudSdkCustomFields,
            chatCompletionRequestAssistantMessageFunctionCall.cloudSdkCustomFields)
        && Objects.equals(
            this.arguments, chatCompletionRequestAssistantMessageFunctionCall.arguments)
