...
public interface EmbeddingsCreateRequestInput  {
     ...
     */
    record InnerString(@com.fasterxml.jackson.annotation.JsonValue String value) implements EmbeddingsCreateRequestInput {}
    ...
    */
    record InnerStrings(@com.fasterxml.jackson.annotation.JsonValue List<String> values) implements EmbeddingsCreateRequestInput {}
