...
class AiCoreHttpClientImpl implements HttpClient {
  ...
  @Nonnull
  private static Headers extractResponseHeaders(@Nonnull final ClassicHttpResponse apacheResponse) {
  ...
  /**
   * HTTP response for streaming requests. Keeps the connection open and provides a live stream. The
   * stream must be closed by calling {@link #close()}.
   */
