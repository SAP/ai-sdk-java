...
// CHECKSTYLE:ON
{
  ...
  @Override
  public int hashCode() {
    return Objects.hash(temperature, topP, stream, stop, maxTokens, maxCompletionTokens, presencePenalty, frequencyPenalty, logitBias, user, messages, logprobs, topLogprobs, n, parallelToolCalls, responseFormat, seed, streamOptions, tools, toolChoice, functionCall, functions, cloudSdkCustomFields);
  }
