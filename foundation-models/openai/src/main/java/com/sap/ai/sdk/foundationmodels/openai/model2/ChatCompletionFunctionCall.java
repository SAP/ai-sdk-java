...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ChatCompletionFunctionCall name( @Nonnull final String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Set the arguments of this {@link ChatCompletionFunctionCall} instance and return the same instance.
   *
   ...
   * @return The same instance of this {@link ChatCompletionFunctionCall} class
   */
  @Nonnull public ChatCompletionFunctionCall arguments( @Nonnull final String arguments) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ChatCompletionFunctionCall} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ChatCompletionFunctionCall has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ChatCompletionFunctionCall} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    return Objects.equals(this.cloudSdkCustomFields, chatCompletionFunctionCall.cloudSdkCustomFields) &&
