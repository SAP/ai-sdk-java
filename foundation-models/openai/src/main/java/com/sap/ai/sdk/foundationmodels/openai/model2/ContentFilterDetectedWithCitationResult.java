...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the filtered of this {@link ContentFilterDetectedWithCitationResult} instance and return the same instance.
   *
   ...
   */
  @Nonnull public ContentFilterDetectedWithCitationResult filtered( @Nonnull final Boolean filtered) {
  ...
  /**
   * Set the detected of this {@link ContentFilterDetectedWithCitationResult} instance and return the same instance.
   *
   * @param detected  The detected of this {@link ContentFilterDetectedWithCitationResult}
   * @return The same instance of this {@link ContentFilterDetectedWithCitationResult} class
   */
  @Nonnull public ContentFilterDetectedWithCitationResult detected( @Nonnull final Boolean detected) {
  ...
  /**
   * Set the citation of this {@link ContentFilterDetectedWithCitationResult} instance and return the same instance.
   *
   * @param citation  The citation of this {@link ContentFilterDetectedWithCitationResult}
   * @return The same instance of this {@link ContentFilterDetectedWithCitationResult} class
   */
  @Nonnull public ContentFilterDetectedWithCitationResult citation( @Nullable final ContentFilterDetectedWithCitationResultAllOfCitation citation) {
   ...
   * @param citation  The citation of this {@link ContentFilterDetectedWithCitationResult}
   */
  public void setCitation( @Nullable final ContentFilterDetectedWithCitationResultAllOfCitation citation) {
    this.citation = citation;
  }

  /**
   * Get the names of the unrecognizable properties of the {@link ContentFilterDetectedWithCitationResult}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ContentFilterDetectedWithCitationResult} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ContentFilterDetectedWithCitationResult has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ContentFilterDetectedWithCitationResult} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    final ContentFilterDetectedWithCitationResult contentFilterDetectedWithCitationResult = (ContentFilterDetectedWithCitationResult) o;
    return Objects.equals(this.cloudSdkCustomFields, contentFilterDetectedWithCitationResult.cloudSdkCustomFields) &&
