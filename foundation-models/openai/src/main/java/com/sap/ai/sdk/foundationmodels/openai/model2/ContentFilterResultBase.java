...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ContentFilterResultBase filtered( @Nonnull final Boolean filtered) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ContentFilterResultBase has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ContentFilterResultBase} instance. If the map previously contained a mapping
