...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public Citation content(@Nonnull final String content) {
   ...
   */
  @Nonnull
  public Citation title(@Nullable final String title) {
    this.title = title;
    return this;
  }
   ...
   */
  @Nonnull
  public Citation url(@Nullable final String url) {
    this.url = url;
    return this;
  }
   ...
   */
  @Nonnull
  public Citation filepath(@Nullable final String filepath) {
   ...
   */
  @Nonnull
  public Citation chunkId(@Nullable final String chunkId) {
