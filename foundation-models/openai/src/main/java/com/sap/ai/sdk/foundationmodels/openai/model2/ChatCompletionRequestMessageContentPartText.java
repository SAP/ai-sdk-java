...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the type of this {@link ChatCompletionRequestMessageContentPartText} instance and return the same instance.
   *
   ...
   */
  @Nonnull public ChatCompletionRequestMessageContentPartText type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Set the text of this {@link ChatCompletionRequestMessageContentPartText} instance and return the same instance.
   *
   * @param text  The text content.
   * @return The same instance of this {@link ChatCompletionRequestMessageContentPartText} class
   */
  @Nonnull public ChatCompletionRequestMessageContentPartText text( @Nonnull final String text) {
    this.text = text;
    return this;
  }
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link ChatCompletionRequestMessageContentPartText}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ChatCompletionRequestMessageContentPartText} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ChatCompletionRequestMessageContentPartText has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ChatCompletionRequestMessageContentPartText} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    final ChatCompletionRequestMessageContentPartText chatCompletionRequestMessageContentPartText = (ChatCompletionRequestMessageContentPartText) o;
    return Objects.equals(this.cloudSdkCustomFields, chatCompletionRequestMessageContentPartText.cloudSdkCustomFields) &&
