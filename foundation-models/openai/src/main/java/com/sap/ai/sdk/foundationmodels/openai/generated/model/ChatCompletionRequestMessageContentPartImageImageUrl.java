...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link ChatCompletionRequestMessageContentPartImageImageUrl}
   *     class
   */
  @Nonnull
  public ChatCompletionRequestMessageContentPartImageImageUrl url(@Nonnull final URI url) {
    this.url = url;
    return this;
  }
   ...
   *
   * @return url The url of this {@link ChatCompletionRequestMessageContentPartImageImageUrl}
   *     instance.
   */
  @Nonnull
  public URI getUrl() {
   ...
   *
   * @param detail Specifies the detail level of the image. Learn more in the [Vision
   *     guide](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/gpt-with-vision?tabs&#x3D;rest%2Csystem-assigned%2Cresource#detail-parameter-settings-in-image-processing-low-high-auto).
   * @return The same instance of this {@link ChatCompletionRequestMessageContentPartImageImageUrl}
   *     class
   */
  @Nonnull
  public ChatCompletionRequestMessageContentPartImageImageUrl detail(
      @Nullable final DetailEnum detail) {
    this.detail = detail;
    return this;
  }
   ...
   * guide](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/gpt-with-vision?tabs&#x3D;rest%2Csystem-assigned%2Cresource#detail-parameter-settings-in-image-processing-low-high-auto).
   *
   * @return detail The detail of this {@link ChatCompletionRequestMessageContentPartImageImageUrl}
   *     instance.
   */
  @Nonnull
   ...
   * ChatCompletionRequestMessageContentPartImageImageUrl} instance.
   *
  ...
  public Object getCustomField(@Nonnull final String name) throws NoSuchElementException {
    if (!cloudSdkCustomFields.containsKey(name)) {
      throw new NoSuchElementException(
          "ChatCompletionRequestMessageContentPartImageImageUrl has no field with name '"
              + name
              + "'.");
    }
   ...
   * ChatCompletionRequestMessageContentPartImageImageUrl} instance including unrecognized
   * properties.
   *
   ...
   * ChatCompletionRequestMessageContentPartImageImageUrl} instance. If the map previously contained
  ...
  public boolean equals(@Nullable final java.lang.Object o) {
    ...
    final ChatCompletionRequestMessageContentPartImageImageUrl
        chatCompletionRequestMessageContentPartImageImageUrl =
            (ChatCompletionRequestMessageContentPartImageImageUrl) o;
    return Objects.equals(
            this.cloudSdkCustomFields,
            chatCompletionRequestMessageContentPartImageImageUrl.cloudSdkCustomFields)
