...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link EmbeddingsCreate200ResponseDataInner} class
   */
  @Nonnull public EmbeddingsCreate200ResponseDataInner embedding( @Nonnull final List<BigDecimal> embedding) {
   ...
   */
  @Nonnull public EmbeddingsCreate200ResponseDataInner addEmbeddingItem( @Nonnull final BigDecimal embeddingItem) {
