...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the content of this {@link ChatCompletionRequestSystemMessage} instance and return the same instance.
   *
   ...
   */
  @Nonnull public ChatCompletionRequestSystemMessage content( @Nonnull final ChatCompletionRequestSystemMessageContent content) {
  ...
  /**
   * Set the role of this {@link ChatCompletionRequestSystemMessage} instance and return the same instance.
   *
   * @param role  The role of the messages author, in this case &#x60;system&#x60;.
   * @return The same instance of this {@link ChatCompletionRequestSystemMessage} class
   */
  @Nonnull public ChatCompletionRequestSystemMessage role( @Nonnull final RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  /**
   * Set the name of this {@link ChatCompletionRequestSystemMessage} instance and return the same instance.
   *
   ...
   * @return The same instance of this {@link ChatCompletionRequestSystemMessage} class
   */
  @Nonnull public ChatCompletionRequestSystemMessage name( @Nullable final String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Get the names of the unrecognizable properties of the {@link ChatCompletionRequestSystemMessage}.
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ChatCompletionRequestSystemMessage} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ChatCompletionRequestSystemMessage has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ChatCompletionRequestSystemMessage} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    final ChatCompletionRequestSystemMessage chatCompletionRequestSystemMessage = (ChatCompletionRequestSystemMessage) o;
    return Objects.equals(this.cloudSdkCustomFields, chatCompletionRequestSystemMessage.cloudSdkCustomFields) &&
