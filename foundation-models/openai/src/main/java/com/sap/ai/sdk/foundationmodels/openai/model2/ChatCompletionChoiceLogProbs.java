...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the content of this {@link ChatCompletionChoiceLogProbs} instance and return the same instance.
   *
   * @param content  A list of message content tokens with log probability information.
   * @return The same instance of this {@link ChatCompletionChoiceLogProbs} class
   */
  @Nonnull public ChatCompletionChoiceLogProbs content( @Nullable final List<ChatCompletionTokenLogprob> content) {
   ...
   */
  @Nonnull public ChatCompletionChoiceLogProbs addContentItem( @Nonnull final ChatCompletionTokenLogprob contentItem) {
  ...
  /**
   * Set the refusal of this {@link ChatCompletionChoiceLogProbs} instance and return the same instance.
   *
   * @param refusal  A list of message refusal tokens with log probability information.
   * @return The same instance of this {@link ChatCompletionChoiceLogProbs} class
   */
  @Nonnull public ChatCompletionChoiceLogProbs refusal( @Nullable final List<ChatCompletionTokenLogprob> refusal) {
   ...
   * @return The same instance of type {@link ChatCompletionChoiceLogProbs}
   */
  @Nonnull public ChatCompletionChoiceLogProbs addRefusalItem( @Nonnull final ChatCompletionTokenLogprob refusalItem) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ChatCompletionChoiceLogProbs} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ChatCompletionChoiceLogProbs has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ChatCompletionChoiceLogProbs} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    final ChatCompletionChoiceLogProbs chatCompletionChoiceLogProbs = (ChatCompletionChoiceLogProbs) o;
    return Objects.equals(this.cloudSdkCustomFields, chatCompletionChoiceLogProbs.cloudSdkCustomFields) &&
