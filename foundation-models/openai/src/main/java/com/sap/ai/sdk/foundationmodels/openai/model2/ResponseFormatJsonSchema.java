...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public ResponseFormatJsonSchema type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Set the jsonSchema of this {@link ResponseFormatJsonSchema} instance and return the same instance.
   *
   * @param jsonSchema  The jsonSchema of this {@link ResponseFormatJsonSchema}
   * @return The same instance of this {@link ResponseFormatJsonSchema} class
   */
  @Nonnull public ResponseFormatJsonSchema jsonSchema( @Nonnull final ResponseFormatJsonSchemaJsonSchema jsonSchema) {
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ResponseFormatJsonSchema has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ResponseFormatJsonSchema} instance. If the map previously contained a mapping
