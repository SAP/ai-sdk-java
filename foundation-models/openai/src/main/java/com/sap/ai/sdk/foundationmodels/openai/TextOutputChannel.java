...
/**
 * Functional interface representing test output channel (text data consumer)
 * <p/>
...
public interface TextOutputChannel {
    ...
    /**
     * This method is sequentially invoked by test data provider to supply implementer (consumer)
     * with the test data.
     *
     ...
     *               single logical entity (e.g. gets called at the end when all parts of a single
     *               message get passed)
     */
