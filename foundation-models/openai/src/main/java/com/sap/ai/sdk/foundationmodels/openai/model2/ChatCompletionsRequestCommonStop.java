...
public interface ChatCompletionsRequestCommonStop  {
     ...
     */
    record InnerString(@com.fasterxml.jackson.annotation.JsonValue String value) implements ChatCompletionsRequestCommonStop {}
    ...
    /**
    * Helper class to create a list of String that implements {@link ChatCompletionsRequestCommonStop}.
    */
    record InnerStrings(@com.fasterxml.jackson.annotation.JsonValue List<String> values) implements ChatCompletionsRequestCommonStop {}
