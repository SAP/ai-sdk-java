...
// CHECKSTYLE:ON
{
  ...
  /**
   * Set the type of this {@link ChatCompletionNamedToolChoice} instance and return the same instance.
   *
   * @param type  The type of the tool. Currently, only &#x60;function&#x60; is supported.
   * @return The same instance of this {@link ChatCompletionNamedToolChoice} class
   */
  @Nonnull public ChatCompletionNamedToolChoice type( @Nonnull final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Set the function of this {@link ChatCompletionNamedToolChoice} instance and return the same instance.
   *
   * @param function  The function of this {@link ChatCompletionNamedToolChoice}
   * @return The same instance of this {@link ChatCompletionNamedToolChoice} class
   */
  @Nonnull public ChatCompletionNamedToolChoice function( @Nonnull final ChatCompletionNamedToolChoiceFunction function) {
  ...
  /**
   * Get the value of an unrecognizable property of this {@link ChatCompletionNamedToolChoice} instance.
  ...
  public Object getCustomField( @Nonnull final String name ) throws NoSuchElementException {
    if( !cloudSdkCustomFields.containsKey(name) ) {
        throw new NoSuchElementException("ChatCompletionNamedToolChoice has no field with name '" + name + "'.");
    }
    return cloudSdkCustomFields.get(name);
  }

  /**
   * Set an unrecognizable property of this {@link ChatCompletionNamedToolChoice} instance. If the map previously contained a mapping
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    final ChatCompletionNamedToolChoice chatCompletionNamedToolChoice = (ChatCompletionNamedToolChoice) o;
    return Objects.equals(this.cloudSdkCustomFields, chatCompletionNamedToolChoice.cloudSdkCustomFields) &&
