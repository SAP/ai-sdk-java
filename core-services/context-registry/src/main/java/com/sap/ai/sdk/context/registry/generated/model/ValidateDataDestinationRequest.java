...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ValidateAzureRequest.class, name = "AZURE"),
  @JsonSubTypes.Type(value = ValidateGCSRequest.class, name = "GCS"),
  @JsonSubTypes.Type(value = ValidateS3Request.class, name = "S3"),
})
public interface ValidateDataDestinationRequest {
  Object getType();
}
