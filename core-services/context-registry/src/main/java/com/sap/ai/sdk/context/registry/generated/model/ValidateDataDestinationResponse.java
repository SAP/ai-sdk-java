...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ValidationFailedResponse.class, name = "FAILED"),
  @JsonSubTypes.Type(value = ValidationOkResponse.class, name = "OK"),
})
public interface ValidateDataDestinationResponse {
  Object getStatus();
}
