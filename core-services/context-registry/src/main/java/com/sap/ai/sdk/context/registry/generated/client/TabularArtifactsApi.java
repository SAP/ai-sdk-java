...
import com.sap.ai.sdk.context.registry.generated.model.TabularArtifactDataPreview;
...
public class TabularArtifactsApi extends BaseApi {
  ...
  public ControllersTabularArtifactV1EndpointsCreateTabularArtifact202Response
    ...
    if (createTARequest == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'createTARequest' when calling controllersTabularArtifactV1EndpointsCreateTabularArtifact")
          .statusCode(400);
    }
