...
import com.sap.ai.sdk.context.registry.generated.model.PatchScenarioConfiguration;
...
import com.sap.ai.sdk.context.registry.generated.model.SearchScenarioConfiguration;
...
public class ScenarioConfigurationManagerApi extends BaseApi {
  ...
  public ScenarioConfigurationNameObject createScenarioConfiguration(
    ...
    if (createScenarioConfiguration == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'createScenarioConfiguration' when calling controllersScenarioConfigurationManagerV1EndpointsCreateScenarioConfiguration")
          .statusCode(400);
    }
  ...
  public OpenApiResponse patchScenarioConfigurationByName(
    ...
    if (patchScenarioConfiguration == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'patchScenarioConfiguration' when calling controllersScenarioConfigurationManagerV1EndpointsPatchScenarioConfigurationByName")
          .statusCode(400);
    }
  ...
  public GetScenarioConfigurations searchScenarioConfigurationsByLabel(
    ...
    if (searchScenarioConfiguration == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'searchScenarioConfiguration' when calling controllersScenarioConfigurationManagerV1EndpointsSearchScenarioConfigurationsByLabel")
          .statusCode(400);
    }
