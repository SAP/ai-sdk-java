package com.sap.ai.sdk.context.registry.generated.client;

import com.fasterxml.jackson.core.type.TypeReference;
import com.sap.ai.sdk.context.registry.generated.model.AsyncCreateDataDestinationResponse;
import com.sap.ai.sdk.context.registry.generated.model.ControllersDataDestinationV1EndpointsSearchDataDestinationsRequest;
import com.sap.ai.sdk.context.registry.generated.model.CreateDataDestination;
import com.sap.ai.sdk.context.registry.generated.model.GetDataDestination;
import com.sap.ai.sdk.context.registry.generated.model.GetDataDestinations;
import com.sap.ai.sdk.context.registry.generated.model.PatchDataDestination;
import com.sap.ai.sdk.context.registry.generated.model.ValidateDataDestinationRequest;
import com.sap.ai.sdk.context.registry.generated.model.ValidateDataDestinationResponse;
...
public class DataDestinationsApi extends BaseApi {
  ...
  public AsyncCreateDataDestinationResponse createUpdateDataDestination(
    ...
    if (createDataDestination == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'createDataDestination' when calling controllersDataDestinationV1EndpointsCreateUpdateDataDestination")
          .statusCode(400);
    }
  ...
  public OpenApiResponse patchDataDestinationByName(
    ...
    if (patchDataDestination == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'patchDataDestination' when calling controllersDataDestinationV1EndpointsPatchDataDestinationByName")
          .statusCode(400);
    }
  ...
  public GetDataDestinations searchDestinations(
    ...
    if (controllersDataDestinationV1EndpointsSearchDataDestinationsRequest == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'controllersDataDestinationV1EndpointsSearchDataDestinationsRequest' when calling controllersDataDestinationV1EndpointsSearchDataDestinations")
          .statusCode(400);
    }
  ...
  public ValidateDataDestinationResponse validateDataDestination(
    ...
    if (validateDataDestinationRequest == null) {
      throw new OpenApiRequestException(
              "Missing the required parameter 'validateDataDestinationRequest' when calling controllersDataDestinationV1EndpointsValidateDataDestination")
          .statusCode(400);
    }
