...
/** Strategy for selecting context in the scenario configuration */
public enum ContextSelectionStrategy {
  ...
  ContextSelectionStrategy(String value) {
    this.value = value;
  }
   ...
   */
  @JsonCreator
  public static ContextSelectionStrategy fromValue(@Nonnull final String value) {
    for (final ContextSelectionStrategy b : ContextSelectionStrategy.values()) {
