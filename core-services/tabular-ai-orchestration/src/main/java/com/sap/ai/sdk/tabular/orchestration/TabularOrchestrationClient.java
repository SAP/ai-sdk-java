...
@Beta
public class TabularOrchestrationClient {
  ...
  /** Default constructor. */
  @Tolerate
  public TabularOrchestrationClient() {
   ...
   */
  public TabularOrchestrationClient(final @Nonnull AiCoreService service) {
   ...
   */
  @Nonnull
  public TabularOrchestrationClient withHeader(
      @Nonnull final String key, @Nonnull final String value) {
    final var newClient = new TabularOrchestrationClient(this.service, this.basePath);
   ...
   */
  @Nonnull
  TabularOrchestrationClient withPredictDestination(@Nonnull final HttpDestination destination) {
