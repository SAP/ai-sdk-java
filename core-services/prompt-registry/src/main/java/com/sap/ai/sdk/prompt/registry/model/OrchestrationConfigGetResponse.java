...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull
  public OrchestrationConfigGetResponse spec(@Nullable final OrchestrationConfigResourceSpec spec) {
    this.spec = spec;
    return this;
  }
   ...
   * @param spec The spec of this {@link OrchestrationConfigGetResponse}
   */
  public void setSpec(@Nullable final OrchestrationConfigResourceSpec spec) {
    this.spec = spec;
  }
